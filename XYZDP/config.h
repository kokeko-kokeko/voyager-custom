...
#define SERIAL_NUMBER "XYZDP/aN0RXJ"
...
#define NAVIGATOR_DRAG_SCROLL_LAYERS {4, 5, 7, AUTOMOUSE_LAYER_TRACKPAD}   //Lt0 Lt1 Rt0 and with trackpad
#define NAVIGATOR_AIM_LAYERS {11, 12} //Lp1 Rp0
#define NAVIGATOR_TURBO_LAYERS {10, 13, 5}   //Lp0 Rp1 Lt1(scroll)
