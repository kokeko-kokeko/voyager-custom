...
#define SERIAL_NUMBER "XYZDP/v6Gqzb"
...
#define AUTOMOUSE_TIMEOUT_TRACKBALL 8009

#define AUTOMOUSE_THRESHOLD_TRACKPAD -1 // must use mod automouse (disable normal path)
#define AUTOMOUSE_THRESHOLD_TRACKBALL 100

#define AUTOMOUSE_SCROLL_THRESHOLD_TRACKPAD 100  
#define AUTOMOUSE_SCROLL_THRESHOLD_TRACKBALL 100
