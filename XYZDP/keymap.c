...
#define DUAL_FUNC_3 LT(1, KC_Y)
#define DUAL_FUNC_4 LT(12, KC_2)
#define DUAL_FUNC_5 LT(7, KC_F13)
#define DUAL_FUNC_6 LT(3, KC_R)
#define DUAL_FUNC_7 LT(15, KC_N)
#define DUAL_FUNC_8 LT(2, KC_E)
#define DUAL_FUNC_9 LT(8, KC_1)
#define DUAL_FUNC_10 LT(1, KC_J)
#define DUAL_FUNC_11 LT(3, KC_4)
#define DUAL_FUNC_12 LT(8, KC_X)
#define DUAL_FUNC_13 LT(7, KC_F22)
#define DUAL_FUNC_14 LT(8, KC_L)
#define DUAL_FUNC_15 LT(8, KC_U)
#define DUAL_FUNC_16 LT(13, KC_F21)
#define DUAL_FUNC_17 LT(11, KC_F19)
#define DUAL_FUNC_18 LT(13, KC_P)
#define DUAL_FUNC_19 LT(13, KC_E)
#define DUAL_FUNC_20 LT(7, KC_T)
#define DUAL_FUNC_21 LT(7, KC_F5)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [16] = LAYOUT_voyager(
    ...
    HSV_0_255_118,  HSV_0_255_119,  HSV_0_255_120,  HSV_0_255_121,  KC_TRANSPARENT, HSV_0_255_123,                                  HSV_0_255_144,  HSV_0_255_145,  HSV_0_255_146,  HSV_0_255_147,  HSV_0_255_148,  HSV_0_255_149,  
  ...
  [17] = LAYOUT_voyager(
    ...
    HSV_43_255_118, HSV_43_255_119, HSV_43_255_120, HSV_43_255_121, HSV_43_255_122, HSV_43_255_123,                                 HSV_43_255_144, HSV_43_255_145, HSV_43_255_146, HSV_43_255_147, HSV_43_255_148, HSV_43_255_149, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, HSV_43_255_151
  ),
  [18] = LAYOUT_voyager(
...
layer_state_t layer_state_set_user(layer_state_t state) {
  ...
  // call color settng
  state = update_tri_layer_state(state, L_Function, L_Set_Val, L_Set_Sat); 
  state = update_tri_layer_state(state, L_Cursor, L_Set_Val, L_Set_Speed); 

  // call Hue with Sat and Speed
  state = update_tri_layer_state(state, L_Set_Sat, L_Set_Speed, L_Set_Hue);
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
 ...
 case DUAL_FUNC_0:
    ...
    case HSV_86_255_100:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[0]]);
      }
      return false;
    case HSV_86_255_101:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[1]]);
      }
      return false;
    case HSV_86_255_102:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[2]]);
      }
      return false;
    case HSV_86_255_103:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[3]]);
      }
      return false;
    case HSV_86_255_104:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[4]]);
      }
      return false;
    case HSV_86_255_105:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[5]]);
      }
      return false;
    case HSV_86_255_106:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[6]]);
      }
      return false;
    case HSV_86_255_107:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[7]]);
      }
      return false;
    case HSV_86_255_108:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[8]]);
      }
      return false;
    case HSV_86_255_109:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[9]]);
      }
      return false;
    case HSV_86_255_110:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[10]]);
      }
      return false;
    case HSV_86_255_111:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[11]]);
      }
      return false;
    case HSV_86_255_112:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[12]]);
      }
      return false;
    case HSV_86_255_113:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[13]]);
      }
      return false;
    case HSV_86_255_114:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[14]]);
      }
      return false;
    case HSV_86_255_115:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[15]]);
      }
      return false;
    case HSV_86_255_116:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[16]]);
      }
      return false;
    case HSV_86_255_117:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[17]]);
      }
      return false;
    case HSV_86_255_118:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[18]]);
      }
      return false;
    case HSV_86_255_119:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[19]]);
      }
      return false;
    case HSV_86_255_120:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[20]]);
      }
      return false;
    case HSV_86_255_121:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[21]]);
      }
      return false;
    case HSV_86_255_122:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[22]]);
      }
      return false;
    case HSV_86_255_123:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[23]]);
      }
      return false;
    case HSV_86_255_126:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[26]]);
      }
      return false;
    case HSV_86_255_127:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[27]]);
      }
      return false;
    case HSV_86_255_128:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[28]]);
      }
      return false;
    case HSV_86_255_129:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[29]]);
      }
      return false;
    case HSV_86_255_130:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[30]]);
      }
      return false;
    case HSV_86_255_131:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[31]]);
      }
      return false;
    case HSV_86_255_132:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[32]]);
      }
      return false;
    case HSV_86_255_133:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[33]]);
      }
      return false;
    case HSV_86_255_134:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[34]]);
      }
      return false;
    case HSV_86_255_135:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[35]]);
      }
      return false;
    case HSV_86_255_136:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[36]]);
      }
      return false;
    case HSV_86_255_137:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[37]]);
      }
      return false;
    case HSV_86_255_138:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[38]]);
      }
      return false;
    case HSV_86_255_139:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[39]]);
      }
      return false;
    case HSV_86_255_140:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[40]]);
      }
      return false;
    case HSV_86_255_141:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[41]]);
      }
      return false;
    case HSV_86_255_142:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[42]]);
      }
      return false;
    case HSV_86_255_143:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[43]]);
      }
      return false;
    case HSV_86_255_144:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[44]]);
      }
      return false;
    case HSV_86_255_145:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[45]]);
      }
      return false;
    case HSV_86_255_146:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[46]]);
      }
      return false;
    case HSV_86_255_147:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[47]]);
      }
      return false;
    case HSV_86_255_148:
      if (record->event.pressed) {
        rgb_matrix_set_speed_noeeprom(spd_tbl[pos2idx_tbl[48]]);
      }
      return false;
    case HSV_86_255_149:
      if (record->event.pressed) {
