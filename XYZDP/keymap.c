...
(uint8_t[]){255, 251, 247, 243, 239, 235, 231, 226,
            222, 218, 214, 210, 206, 202, 198, 194,
            190, 186, 182, 178, 173, 169, 165, 161,
            157, 153, 149, 145, 141, 137, 133, 129,
            125, 120, 116, 112, 108, 104, 100,  96,
             84,  72,  60,  49,  37,  25,  13,   1};
// val value max limit 175
static const uint8_t * const val_tbl = 
(uint8_t[]){175, 168, 162, 155, 148, 141, 135, 128,
            126, 123, 121, 118, 116, 113, 111, 108,
            106, 103, 101,  98,  96,  93,  91,  88,
             86,  83,  81,  78,  76,  73,  71,  68,
             66,  63,  61,  58,  56,  53,  51,  48,
             42,  36,  30,  25,  19,  13,   7,   1};
...
static void rgblight_load_preset(void) {
  rgblight_sethsv_noeeprom(250, 255, 111);
