...
#define DUAL_FUNC_3 LT(7, KC_I)
#define DUAL_FUNC_4 LT(8, KC_C)
#define DUAL_FUNC_5 LT(7, KC_J)
#define DUAL_FUNC_6 LT(5, KC_F24)
#define DUAL_FUNC_7 LT(8, KC_P)
