...
#define DUAL_FUNC_19 LT(8, KC_T)
#define DUAL_FUNC_20 LT(11, KC_F12)
#define DUAL_FUNC_21 LT(7, KC_E)
#define DUAL_FUNC_22 LT(12, KC_F16)
#define DUAL_FUNC_23 LT(8, KC_F5)
