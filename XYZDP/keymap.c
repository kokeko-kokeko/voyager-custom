...
#define DUAL_FUNC_17 LT(15, KC_F4)
#define DUAL_FUNC_18 LT(12, KC_F1)
#define DUAL_FUNC_19 LT(9, KC_F)
#define DUAL_FUNC_20 LT(3, KC_F10)
#define DUAL_FUNC_21 LT(6, KC_2)
