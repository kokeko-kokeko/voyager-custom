...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    MO(7),          MO(6),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     RCTL(KC_MS_BTN1),RSFT(KC_MS_BTN1),RALT(KC_MS_BTN1),RGUI(KC_MS_BTN1),MO(9),          
  ...
  [2] = LAYOUT_voyager(
    ...
    MO(7),          MO(6),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(8),          MO(9),          
