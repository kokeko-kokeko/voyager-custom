...
#define DUAL_FUNC_4 LT(12, KC_F21)
#define DUAL_FUNC_5 LT(13, KC_F6)
#define DUAL_FUNC_6 LT(7, KC_G)
#define DUAL_FUNC_7 LT(9, KC_6)
#define DUAL_FUNC_8 LT(11, KC_F23)
#define DUAL_FUNC_9 LT(1, KC_V)
#define DUAL_FUNC_10 LT(7, KC_F16)
#define DUAL_FUNC_11 LT(8, KC_P)
#define DUAL_FUNC_12 LT(2, KC_F8)
#define DUAL_FUNC_13 LT(15, KC_2)
#define DUAL_FUNC_14 LT(6, KC_F9)
#define DUAL_FUNC_15 LT(5, KC_C)
#define DUAL_FUNC_16 LT(1, KC_Z)
#define DUAL_FUNC_17 LT(7, KC_F4)
#define DUAL_FUNC_18 LT(7, KC_F2)
#define DUAL_FUNC_19 LT(5, KC_F15)
#define DUAL_FUNC_20 LT(14, KC_F5)
#define DUAL_FUNC_21 LT(1, KC_F10)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_ESCAPE,                                      TOGGLE_SCROLL,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
