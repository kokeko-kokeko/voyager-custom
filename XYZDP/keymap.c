...
#define DUAL_FUNC_4 LT(3, KC_F5)
#define DUAL_FUNC_5 LT(9, KC_F3)
#define DUAL_FUNC_6 LT(12, KC_F1)
#define DUAL_FUNC_7 LT(7, KC_F15)
#define DUAL_FUNC_8 LT(14, KC_F5)
#define DUAL_FUNC_9 LT(9, KC_F24)
#define DUAL_FUNC_10 LT(12, KC_F8)
#define DUAL_FUNC_11 LT(7, KC_F6)
#define DUAL_FUNC_12 LT(3, KC_P)
#define DUAL_FUNC_13 LT(12, KC_F7)
#define DUAL_FUNC_14 LT(13, KC_G)
#define DUAL_FUNC_15 LT(8, KC_F10)
#define DUAL_FUNC_16 LT(8, KC_F15)
#define DUAL_FUNC_17 LT(9, KC_D)
#define DUAL_FUNC_18 LT(14, KC_F)
#define DUAL_FUNC_19 LT(3, KC_U)
#define DUAL_FUNC_20 LT(2, KC_S)
#define DUAL_FUNC_21 LT(4, KC_F8)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    ...
    MO(9),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(10),         
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, MO(5),          KC_LANGUAGE_2,                                  KC_LANGUAGE_1,  MO(7),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN6,                                     KC_MS_BTN5,     KC_MS_BTN6,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN5,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN4,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
        ...
        if (record->event.key.row < MATRIX_ROWS / 2) {
          ...
          if (record->event.pressed) {
            ...
            if (mouse_button_duration < AUTO_MOUSE_DRAG_THRESHOLD) {
              fast_timer_t now = timer_read_fast();
              auto_mouse_early_trigger = now + AUTO_MOUSE_TIME_LEFT;
            }
          }
        } else {
          ...
          if (record->event.pressed) {
            ...
            if (mouse_button_duration < AUTO_MOUSE_DRAG_THRESHOLD) {
              fast_timer_t now = timer_read_fast();
              auto_mouse_early_trigger = now + AUTO_MOUSE_TIME_RIGHT;
            }
          }
        }
        break;
