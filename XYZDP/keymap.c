...
#define DUAL_FUNC_1 LT(4, KC_I)
#define DUAL_FUNC_2 LT(8, KC_Z)
#define DUAL_FUNC_3 LT(15, KC_Q)
#define DUAL_FUNC_4 LT(4, KC_W)
#define DUAL_FUNC_5 LT(5, KC_J)
#define DUAL_FUNC_6 LT(14, KC_F13)
#define DUAL_FUNC_7 LT(14, KC_V)
#define DUAL_FUNC_8 LT(14, KC_F5)
#define DUAL_FUNC_9 LT(5, KC_F21)
#define DUAL_FUNC_10 LT(12, KC_J)
#define DUAL_FUNC_11 LT(12, KC_P)
#define DUAL_FUNC_12 LT(1, KC_F20)
#define DUAL_FUNC_13 LT(5, KC_O)
#define DUAL_FUNC_14 LT(6, KC_5)
#define DUAL_FUNC_15 LT(10, KC_F1)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    LT(11, KC_B),   MT(MOD_LSFT | MOD_LCTL, KC_H),MT(MOD_LGUI | MOD_LALT, KC_I),MT(MOD_LSFT, KC_A),MT(MOD_LCTL, KC_E),KC_COMMA,                                       KC_DOT,         MT(MOD_RCTL, KC_T),MT(MOD_RSFT, KC_R),MT(MOD_RGUI | MOD_RALT, KC_S),MT(MOD_RSFT | MOD_RCTL, KC_C),LT(10, KC_V),   
  ...
  [3] = LAYOUT_voyager(
    ...
    MO(11),         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN3,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(10),         
  ...
  [5] = LAYOUT_voyager(
    ...
    LT(11, KC_F11), MT(MOD_LSFT | MOD_LCTL, KC_F1),MT(MOD_LGUI | MOD_LALT, KC_F2),MT(MOD_LSFT, KC_F3),MT(MOD_LCTL, KC_F4),KC_F5,                                          KC_F6,          MT(MOD_RCTL, KC_F7),MT(MOD_RSFT, KC_F8),MT(MOD_RGUI | MOD_RALT, KC_F9),MT(MOD_RSFT | MOD_RCTL, KC_F10),LT(10, KC_F12), 
  ...
  [7] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    LT(11, KC_LBRC),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LT(10, KC_RBRC),
  ...
  [8] = LAYOUT_voyager(
    ...
    MO(11),         LCTL(KC_A),     LCTL(KC_S),     DUAL_FUNC_12,   DUAL_FUNC_13,   KC_SCLN,                                        JP_COLN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      MO(10),         
