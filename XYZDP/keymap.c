...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [16] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_N),MT(MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LSFT | MOD_LCTL, KC_M),LGUI(LSFT(KC_V)),                                KC_BSPC,        MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_I),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_J),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_K),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_L),KC_RIGHT_CTRL,  
  ...
  [19] = LAYOUT_voyager(
    MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),                                MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),
    MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),                                MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),
    MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),                                MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),
    KC_LEFT_SHIFT,  KC_CAPS,        KC_NO,          KC_TRANSPARENT, KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_3),                                KC_NUM,         KC_SCRL,        KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LSFT | MOD_LCTL, KC_1),
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 MT(MOD_LSFT | MOD_LCTL, KC_2),MT(MOD_LSFT | MOD_LCTL, KC_3)
  ),
  [20] = LAYOUT_voyager(
    MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),                                MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),
    MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),                                MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),
    MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),                                MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),
    MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),                                MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LSFT | MOD_LCTL, KC_4),
                                                    MT(MOD_LSFT | MOD_LCTL, KC_5),MT(MOD_LSFT | MOD_LCTL, KC_6),                                MT(MOD_LSFT | MOD_LCTL, KC_7),MT(MOD_LSFT | MOD_LCTL, KC_8)
  ),
};
