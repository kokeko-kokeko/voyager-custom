...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    MT(MOD_RCTL, KC_A),MT(MOD_RCTL, KC_B),MT(MOD_LCTL, KC_Y),MT(MOD_LCTL, KC_O),MT(MOD_LCTL, KC_U),MT(MOD_RCTL, KC_C),                                MT(MOD_RCTL, KC_G),MT(MOD_LCTL, KC_D),MT(MOD_LCTL, KC_N),MT(MOD_LCTL, KC_G),MT(MOD_RCTL, KC_F),MT(MOD_RCTL, KC_Z),
    ...
    MT(MOD_RSFT | MOD_RALT, KC_A),KC_LEFT,        KC_RIGHT,       KC_BSPC,        MT(MOD_LCTL, KC_SPACE),MT(MOD_LCTL, KC_LANGUAGE_2),                                MT(MOD_LCTL, KC_LANGUAGE_1),MT(MOD_LCTL, KC_SPACE),MT(MOD_LCTL, KC_DELETE),KC_UP,          KC_DOWN,        MT(MOD_RSFT | MOD_RALT, KC_A),
  ...
  [1] = LAYOUT_voyager(
    ...
    MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),
    MT(MOD_RSFT | MOD_RALT, KC_A),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN2,                                     KC_MS_BTN1,     MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_MS_BTN1,                                     KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [2] = LAYOUT_voyager(
    LGUI(KC_TAB),   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN2,     KC_MS_BTN4,                                     KC_MS_BTN4,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),
    MT(MOD_RSFT | MOD_RALT, KC_A),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN1,                                     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_RSFT | MOD_RALT, KC_A),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_MS_BTN1,     KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
    MT(MOD_RCTL, KC_Z),KC_TRANSPARENT, MT(MOD_RCTL, KC_COMMA),MT(MOD_RCTL, KC_DOT),MT(MOD_RCTL, KC_6),MT(MOD_RSFT | MOD_RCTL, KC_6),                                MT(MOD_RSFT | MOD_RCTL, KC_5),MT(MOD_RCTL, KC_5),MT(MOD_RCTL, KC_COMMA),MT(MOD_RCTL, KC_DOT),KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_voyager(
    MT(MOD_RCTL, KC_Z),MT(MOD_LCTL, KC_F21),MT(MOD_LCTL, KC_F22),MT(MOD_LCTL, KC_F23),MT(MOD_LCTL, KC_F24),KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_LCTL, KC_F11),MT(MOD_LCTL, KC_F12),MT(MOD_LCTL, KC_F13),MT(MOD_LCTL, KC_F14),MT(MOD_LCTL, KC_F15),                                MT(MOD_LCTL, KC_F16),MT(MOD_LCTL, KC_F17),MT(MOD_LCTL, KC_F18),MT(MOD_LCTL, KC_F19),MT(MOD_LCTL, KC_F20),MT(MOD_RSFT | MOD_RALT, KC_A),
  ...
  [5] = LAYOUT_voyager(
    MT(MOD_RCTL, KC_Z),MT(MOD_LCTL, KC_HOME),MT(MOD_LCTL, KC_END),MT(MOD_RALT, KC_P),MT(MOD_RALT, KC_N),MT(MOD_RSFT | MOD_RCTL, KC_C),                                MT(MOD_RSFT | MOD_RCTL, KC_G),LCTL(KC_V),     KC_UP,          LCTL(KC_C),     KC_APPLICATION, KC_BSPC,        
    MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_LCTL, KC_PAGE_UP),MT(MOD_LCTL, KC_PGDN),MT(MOD_LALT, KC_C),MT(MOD_LALT, KC_V),MT(MOD_RSFT | MOD_RCTL, KC_D),                                MT(MOD_RSFT | MOD_RCTL, KC_H),KC_LEFT,        KC_DOWN,        KC_RIGHT,       MT(MOD_LCTL, KC_DELETE),MT(MOD_RSFT | MOD_RALT, KC_A),
    MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_LALT, KC_Z),MT(MOD_LALT, KC_X),MT(MOD_LALT, KC_P),MT(MOD_LALT, KC_N),MT(MOD_RSFT | MOD_RCTL, KC_E),                                MT(MOD_RSFT | MOD_RCTL, KC_I),MT(MOD_LALT, KC_1),MT(MOD_LALT, KC_2),MT(MOD_LALT, KC_3),MT(MOD_LALT, KC_4),MT(MOD_RSFT | MOD_RALT, KC_A),
  ...
  [10] = LAYOUT_voyager(
    MT(MOD_RCTL, KC_Z),MT(MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LSFT | MOD_LCTL, KC_M),LGUI(LCTL(KC_V)),                                KC_ESCAPE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_LALT, KC_5),MT(MOD_LALT, KC_6),MT(MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LSFT | MOD_LCTL, KC_M),LGUI(LSFT(KC_V)),                                KC_BSPC,        MT(MOD_LSFT | MOD_LALT, KC_1),MT(MOD_LSFT | MOD_LALT, KC_2),MT(MOD_LSFT | MOD_LALT, KC_3),MT(MOD_LSFT | MOD_LALT, KC_4),MT(MOD_RSFT | MOD_RALT, KC_A),
  ...
  [11] = LAYOUT_voyager(
    ...
    MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),                                MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),
    MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),                                MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),
    KC_TRANSPARENT, KC_CAPS,        KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_F),KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_H),                                KC_NUM,         KC_SCRL,        KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 MT(MOD_LSFT | MOD_LCTL, KC_H),MO(12)
  ),
  [12] = LAYOUT_voyager(
