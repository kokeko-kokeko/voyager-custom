...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_voyager(
    CW_TOGG,        DUAL_FUNC_4,    DUAL_FUNC_5,    KC_PAGE_UP,     KC_HOME,        LGUI(LCTL(KC_V)),                                KC_TAB,         LCTL(KC_LEFT),  KC_UP,          LCTL(KC_RIGHT), KC_ESCAPE,      KC_APPLICATION, 
    KC_TRANSPARENT, DUAL_FUNC_6,    DUAL_FUNC_7,    LCTL(KC_C),     LCTL(KC_V),     LGUI(KC_V),                                     KC_BSPC,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      KC_TRANSPARENT, 
    LCTL(KC_Y),     LCTL(KC_Z),     LCTL(KC_X),     KC_PGDN,        KC_END,         LGUI(LSFT(KC_V)),                                LGUI(LCTL(KC_T)),LCTL(LSFT(KC_P)),LALT(LGUI(KC_SPACE)),LGUI(LSFT(KC_M)),LGUI(LSFT(KC_C)),ST_MACRO_14,    
...
// num (only shift override)
const key_override_t ko_ansi_num_1s = ko_make_with_layers(MOD_MASK_SHIFT, KC_1, KC_PIPE, 1 << 1);
const key_override_t ko_ansi_num_2s = ko_make_with_layers(MOD_MASK_SHIFT, KC_2, KC_EQL,  1 << 1);
const key_override_t ko_ansi_num_3s = ko_make_with_layers(MOD_MASK_SHIFT, KC_3, KC_TILD, 1 << 1);
const key_override_t ko_ansi_num_4s = ko_make_with_layers(MOD_MASK_SHIFT, KC_4, KC_PLUS, 1 << 1);
const key_override_t ko_ansi_num_5s = ko_make_with_layers(MOD_MASK_SHIFT, KC_5, KC_LABK, 1 << 1);
const key_override_t ko_ansi_num_6s = ko_make_with_layers(MOD_MASK_SHIFT, KC_6, KC_RABK, 1 << 1);
const key_override_t ko_ansi_num_7s = ko_make_with_layers(MOD_MASK_SHIFT, KC_7, KC_CIRC, 1 << 1);
const key_override_t ko_ansi_num_8s = ko_make_with_layers(MOD_MASK_SHIFT, KC_8, KC_AMPR, 1 << 1);
const key_override_t ko_ansi_num_9s = ko_make_with_layers(MOD_MASK_SHIFT, KC_9, KC_PERC, 1 << 1);
...
const key_override_t ko_jis_base_3s = ko_make_with_layers(MOD_MASK_SHIFT, KC_3, JP_UNDS, 1 << 0);
const key_override_t ko_jis_base_3  = ko_make_with_layers(             0, KC_3, JP_MINS, 1 << 0);
const key_override_t ko_jis_base_4s = ko_make_with_layers(MOD_MASK_SHIFT, KC_4, JP_RPRN, 1 << 0);
const key_override_t ko_jis_base_4  = ko_make_with_layers(             0, KC_4, JP_DQUO, 1 << 0);
const key_override_t ko_jis_base_5s = ko_make_with_layers(MOD_MASK_SHIFT, KC_5, JP_EXLM, 1 << 0);
const key_override_t ko_jis_base_5  = ko_make_with_layers(             0, KC_5, JP_QUES, 1 << 0);

const key_override_t ko_jis_base_QUOTs = ko_make_with_layers(MOD_MASK_SHIFT, KC_QUOT, JP_LPRN, 1 << 0);
const key_override_t ko_jis_base_COMMs = ko_make_with_layers(MOD_MASK_SHIFT, KC_COMM, JP_SCLN, 1 << 0);
const key_override_t ko_jis_base_DOTs = ko_make_with_layers(MOD_MASK_SHIFT, KC_DOT, JP_COLN, 1 << 0);
const key_override_t ko_jis_base_SLSHs = ko_make_with_layers(MOD_MASK_SHIFT, KC_SLSH, JP_BSLS, 1 << 0);

// num (only shift override)
const key_override_t ko_jis_num_1s = ko_make_with_layers(MOD_MASK_SHIFT, KC_1, JP_PIPE, 1 << 1);
const key_override_t ko_jis_num_2s = ko_make_with_layers(MOD_MASK_SHIFT, KC_2, JP_EQL,  1 << 1);
const key_override_t ko_jis_num_3s = ko_make_with_layers(MOD_MASK_SHIFT, KC_3, JP_TILD, 1 << 1);
const key_override_t ko_jis_num_4s = ko_make_with_layers(MOD_MASK_SHIFT, KC_4, JP_PLUS, 1 << 1);
const key_override_t ko_jis_num_5s = ko_make_with_layers(MOD_MASK_SHIFT, KC_5, JP_LABK, 1 << 1);
const key_override_t ko_jis_num_6s = ko_make_with_layers(MOD_MASK_SHIFT, KC_6, JP_RABK, 1 << 1);
const key_override_t ko_jis_num_7s = ko_make_with_layers(MOD_MASK_SHIFT, KC_7, JP_CIRC, 1 << 1);
const key_override_t ko_jis_num_8s = ko_make_with_layers(MOD_MASK_SHIFT, KC_8, JP_AMPR, 1 << 1);
const key_override_t ko_jis_num_9s = ko_make_with_layers(MOD_MASK_SHIFT, KC_9, JP_PERC, 1 << 1);
const key_override_t ko_jis_num_0s = ko_make_with_layers(MOD_MASK_SHIFT, KC_0, JP_ASTR, 1 << 1);
// ANSI to JIS
const key_override_t ko_ansi_to_jis_0  = ko_make_basic(MOD_MASK_SHIFT, KC_GRV, JP_TILD);
const key_override_t ko_ansi_to_jis_1  = ko_make_basic(             0, KC_GRV, JP_GRV);
const key_override_t ko_ansi_to_jis_2  = ko_make_basic(MOD_MASK_SHIFT, KC_2, JP_AT);
const key_override_t ko_ansi_to_jis_3  = ko_make_basic(MOD_MASK_SHIFT, KC_6, JP_CIRC);
const key_override_t ko_ansi_to_jis_4  = ko_make_basic(MOD_MASK_SHIFT, KC_7, JP_AMPR);
const key_override_t ko_ansi_to_jis_5  = ko_make_basic(MOD_MASK_SHIFT, KC_8, JP_ASTR);
const key_override_t ko_ansi_to_jis_6  = ko_make_basic(MOD_MASK_SHIFT, KC_9, JP_LPRN);
const key_override_t ko_ansi_to_jis_7  = ko_make_basic(MOD_MASK_SHIFT, KC_0, JP_RPRN);
const key_override_t ko_ansi_to_jis_8  = ko_make_basic(MOD_MASK_SHIFT, KC_MINS, JP_UNDS);
const key_override_t ko_ansi_to_jis_9  = ko_make_basic(             0, KC_MINS, JP_MINS);
const key_override_t ko_ansi_to_jis_10 = ko_make_basic(MOD_MASK_SHIFT, KC_EQL, JP_PLUS);
const key_override_t ko_ansi_to_jis_11 = ko_make_basic(             0, KC_EQL, JP_EQL);
const key_override_t ko_ansi_to_jis_12 = ko_make_basic(             0, KC_LBRC , JP_LBRC);
const key_override_t ko_ansi_to_jis_13 = ko_make_basic(             0, KC_RBRC , JP_RBRC);
const key_override_t ko_ansi_to_jis_14 = ko_make_basic(MOD_MASK_SHIFT, KC_BSLS , JP_PIPE);
const key_override_t ko_ansi_to_jis_15 = ko_make_basic(             0, KC_BSLS , JP_BSLS);
const key_override_t ko_ansi_to_jis_16 = ko_make_basic(MOD_MASK_SHIFT, KC_SCLN , JP_COLN);
const key_override_t ko_ansi_to_jis_17 = ko_make_basic(             0, KC_SCLN , JP_SCLN);
const key_override_t ko_ansi_to_jis_18 = ko_make_basic(MOD_MASK_SHIFT, KC_QUOT , JP_DQUO);
const key_override_t ko_ansi_to_jis_19 = ko_make_basic(             0, KC_QUOT , JP_QUOT);

const key_override_t **key_overrides_jis =
(const key_override_t *[]){ &ko_jis_base_1s, &ko_jis_base_1, &ko_jis_base_2s, &ko_jis_base_2, &ko_jis_base_3s, &ko_jis_base_3, &ko_jis_base_4s, &ko_jis_base_4, &ko_jis_base_5s, &ko_jis_base_5,
                            &ko_jis_base_QUOTs, &ko_jis_base_COMMs, &ko_jis_base_DOTs, &ko_jis_base_SLSHs,
                            &ko_jis_num_1s, &ko_jis_num_2s, &ko_jis_num_3s, &ko_jis_num_4s, &ko_jis_num_5s,
                            &ko_jis_num_6s, &ko_jis_num_7s, &ko_jis_num_8s, &ko_jis_num_9s, &ko_jis_num_0s,
