...
#define DUAL_FUNC_1 LT(6, KC_F2)
#define DUAL_FUNC_2 LT(10, KC_F2)
#define DUAL_FUNC_3 LT(1, KC_L)
#define DUAL_FUNC_4 LT(15, KC_Y)
#define DUAL_FUNC_5 LT(1, KC_7)
#define DUAL_FUNC_6 LT(6, KC_T)
#define DUAL_FUNC_7 LT(4, KC_F2)
#define DUAL_FUNC_8 LT(3, KC_F14)
#define DUAL_FUNC_9 LT(7, KC_P)
#define DUAL_FUNC_10 LT(7, KC_2)
#define DUAL_FUNC_11 LT(7, KC_0)
#define DUAL_FUNC_12 LT(2, KC_B)
#define DUAL_FUNC_13 LT(14, KC_X)
#define DUAL_FUNC_14 LT(14, KC_F9)
#define DUAL_FUNC_15 LT(15, KC_F)
#define DUAL_FUNC_16 LT(15, KC_F12)
#define DUAL_FUNC_17 LT(5, KC_U)
#define DUAL_FUNC_18 LT(10, KC_F6)
#define DUAL_FUNC_19 LT(3, KC_L)
#define DUAL_FUNC_20 LT(15, KC_F3)
#define DUAL_FUNC_21 LT(8, KC_E)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 DRAG_SCROLL,    KC_MS_BTN1,     KC_MS_BTN3,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
