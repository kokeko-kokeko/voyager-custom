...
#define DUAL_FUNC_13 LT(3, KC_F20)
#define DUAL_FUNC_14 LT(4, KC_F11)
#define DUAL_FUNC_15 LT(9, KC_A)
#define DUAL_FUNC_16 LT(1, KC_0)
#define DUAL_FUNC_17 LT(10, KC_9)
#define DUAL_FUNC_18 LT(3, KC_9)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [16] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN7,     KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN2,     KC_LANGUAGE_6,  NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_TRANSPARENT, 
