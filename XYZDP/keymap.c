...
#define DUAL_FUNC_2 LT(7, KC_E)
#define DUAL_FUNC_3 LT(9, KC_M)
#define DUAL_FUNC_4 LT(14, KC_A)
#define DUAL_FUNC_5 LT(10, KC_Y)
#define DUAL_FUNC_6 LT(11, KC_T)
#define DUAL_FUNC_7 LT(2, KC_2)
#define DUAL_FUNC_8 LT(8, KC_1)
#define DUAL_FUNC_9 LT(5, KC_F20)
#define DUAL_FUNC_10 LT(7, KC_F5)
#define DUAL_FUNC_11 LT(6, KC_6)
#define DUAL_FUNC_12 LT(12, KC_5)
#define DUAL_FUNC_13 LT(4, KC_F17)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_LEFT,        KC_RIGHT,       KC_BSPC,        LT(5, KC_SPACE),KC_LANGUAGE_2,                                  LT(4, KC_LANGUAGE_1),LT(2, KC_SPACE),KC_DELETE,      KC_UP,          KC_DOWN,        KC_RIGHT_SHIFT, 
                                                    LT(4, KC_TAB),  TD(DANCE_0),                                    TD(DANCE_1),    KC_ENTER
  ),
  [1] = LAYOUT_voyager(
