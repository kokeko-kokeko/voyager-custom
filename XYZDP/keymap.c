...
#define DUAL_FUNC_8 LT(12, KC_Q)
#define DUAL_FUNC_9 LT(6, KC_F14)
#define DUAL_FUNC_10 LT(13, KC_T)
#define DUAL_FUNC_11 LT(8, KC_F8)
#define DUAL_FUNC_12 LT(10, KC_D)
#define DUAL_FUNC_13 LT(3, KC_S)
#define DUAL_FUNC_14 LT(1, KC_T)
#define DUAL_FUNC_15 LT(9, KC_F24)
#define DUAL_FUNC_16 LT(15, KC_B)
#define DUAL_FUNC_17 LT(8, KC_U)
#define DUAL_FUNC_18 LT(2, KC_F12)
#define DUAL_FUNC_19 LT(14, KC_F7)
#define DUAL_FUNC_20 LT(5, KC_Q)
#define DUAL_FUNC_21 LT(9, KC_V)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN6,     DRAG_SCROLL,                                    KC_MS_BTN4,     KC_MS_BTN3,     KC_MS_BTN6,     KC_MS_BTN7,     KC_MS_BTN8,     KC_RIGHT_CTRL,  
