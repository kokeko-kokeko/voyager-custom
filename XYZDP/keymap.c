...
#define DUAL_FUNC_7 LT(2, KC_3)
#define DUAL_FUNC_8 LT(7, KC_F18)
#define DUAL_FUNC_9 LT(5, KC_F12)
#define DUAL_FUNC_10 LT(6, KC_1)
#define DUAL_FUNC_11 LT(5, KC_B)
#define DUAL_FUNC_12 LT(4, KC_M)
#define DUAL_FUNC_13 LT(1, KC_P)
#define DUAL_FUNC_14 LT(15, KC_F24)
#define DUAL_FUNC_15 LT(3, KC_T)
#define DUAL_FUNC_16 LT(11, KC_Y)
#define DUAL_FUNC_17 LT(12, KC_G)
#define DUAL_FUNC_18 LT(14, KC_W)
#define DUAL_FUNC_19 LT(1, KC_F4)
