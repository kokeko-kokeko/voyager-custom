...
#define DUAL_FUNC_17 LT(2, KC_F)
#define DUAL_FUNC_18 LT(5, KC_F18)
#define DUAL_FUNC_19 LT(12, KC_G)
#define DUAL_FUNC_20 LT(14, KC_U)
#define DUAL_FUNC_21 LT(9, KC_K)
