...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [16] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_N),MT(MOD_LALT | MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_A),MT(MOD_LALT | MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_A),LGUI(LSFT(KC_V)),                                KC_BSPC,        MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_H),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_G),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_F),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_E),KC_RIGHT_CTRL,  
