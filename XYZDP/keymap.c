...
#define DUAL_FUNC_9 LT(5, KC_V)
#define DUAL_FUNC_10 LT(15, KC_N)
#define DUAL_FUNC_11 LT(6, KC_M)
#define DUAL_FUNC_12 LT(3, KC_F6)
#define DUAL_FUNC_13 LT(5, KC_S)
#define DUAL_FUNC_14 LT(5, KC_A)
#define DUAL_FUNC_15 LT(11, KC_P)
#define DUAL_FUNC_16 LT(3, KC_K)
#define DUAL_FUNC_17 LT(3, KC_C)
#define DUAL_FUNC_18 LT(5, KC_F16)
#define DUAL_FUNC_19 LT(5, KC_F3)
#define DUAL_FUNC_20 LT(7, KC_X)
#define DUAL_FUNC_21 LT(9, KC_X)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_9,                                  TOGGLE_SCROLL,  KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
