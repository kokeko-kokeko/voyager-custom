...
#define DUAL_FUNC_0 LT(10, KC_C)
#define DUAL_FUNC_1 LT(8, KC_7)
#define DUAL_FUNC_2 LT(10, KC_F10)
#define DUAL_FUNC_3 LT(11, KC_3)
#define DUAL_FUNC_4 LT(13, KC_F7)
#define DUAL_FUNC_5 LT(11, KC_I)
#define DUAL_FUNC_6 LT(10, KC_9)
#define DUAL_FUNC_7 LT(15, KC_H)
#define DUAL_FUNC_8 LT(11, KC_G)
#define DUAL_FUNC_9 LT(3, KC_F9)
#define DUAL_FUNC_10 LT(6, KC_2)
#define DUAL_FUNC_11 LT(1, KC_F3)
#define DUAL_FUNC_12 LT(7, KC_K)
#define DUAL_FUNC_13 LT(8, KC_F)
#define DUAL_FUNC_14 LT(14, KC_T)
#define DUAL_FUNC_15 LT(9, KC_F19)
#define DUAL_FUNC_16 LT(6, KC_U)
#define DUAL_FUNC_17 LT(7, KC_F1)
#define DUAL_FUNC_18 LT(5, KC_L)
#define DUAL_FUNC_19 LT(9, KC_F14)
#define DUAL_FUNC_20 LT(3, KC_F16)
#define DUAL_FUNC_21 LT(1, KC_F19)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_voyager(
    ...
    QK_LLCK,        NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN2,                                     KC_TRANSPARENT, KC_MS_BTN1,     KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,QK_LLCK,        
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [5] = LAYOUT_voyager(
