...
#define DUAL_FUNC_8 LT(3, KC_C)
#define DUAL_FUNC_9 LT(12, KC_S)
#define DUAL_FUNC_10 LT(5, KC_J)
#define DUAL_FUNC_11 LT(7, KC_Q)
#define DUAL_FUNC_12 LT(7, KC_7)
#define DUAL_FUNC_13 LT(10, KC_F24)
#define DUAL_FUNC_14 LT(3, KC_F3)
#define DUAL_FUNC_15 LT(3, KC_W)
#define DUAL_FUNC_16 LT(2, KC_F11)
#define DUAL_FUNC_17 LT(5, KC_H)
#define DUAL_FUNC_18 LT(6, KC_F11)
#define DUAL_FUNC_19 LT(1, KC_5)
#define DUAL_FUNC_20 LT(4, KC_F21)
#define DUAL_FUNC_21 LT(1, KC_F24)
#define DUAL_FUNC_22 LT(11, KC_F17)
#define DUAL_FUNC_23 LT(1, KC_D)
