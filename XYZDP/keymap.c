...
#define DUAL_FUNC_6 LT(6, KC_J)
#define DUAL_FUNC_7 LT(11, KC_F10)
#define DUAL_FUNC_8 LT(3, KC_R)
#define DUAL_FUNC_9 LT(12, KC_F22)
#define DUAL_FUNC_10 LT(2, KC_F3)
#define DUAL_FUNC_11 LT(8, KC_8)
#define DUAL_FUNC_12 LT(1, KC_7)
#define DUAL_FUNC_13 LT(6, KC_F24)
#define DUAL_FUNC_14 LT(4, KC_O)
#define DUAL_FUNC_15 LT(9, KC_8)
#define DUAL_FUNC_16 LT(1, KC_F14)
#define DUAL_FUNC_17 LT(8, KC_R)
#define DUAL_FUNC_18 LT(15, KC_8)
#define DUAL_FUNC_19 LT(11, KC_F6)
#define DUAL_FUNC_20 LT(13, KC_F12)
#define DUAL_FUNC_21 LT(4, KC_E)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_8,  KC_MS_BTN3,                                     KC_LANGUAGE_9,  DRAG_SCROLL,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
