...
#define DUAL_FUNC_2 LT(3, KC_F6)
#define DUAL_FUNC_3 LT(5, KC_N)
#define DUAL_FUNC_4 LT(1, KC_F3)
#define DUAL_FUNC_5 LT(10, KC_F18)
#define DUAL_FUNC_6 LT(9, KC_N)
#define DUAL_FUNC_7 LT(14, KC_F12)
#define DUAL_FUNC_8 LT(3, KC_F4)
#define DUAL_FUNC_9 LT(3, KC_V)
#define DUAL_FUNC_10 LT(9, KC_F19)
#define DUAL_FUNC_11 LT(8, KC_C)
#define DUAL_FUNC_12 LT(2, KC_X)
#define DUAL_FUNC_13 LT(13, KC_F3)
#define DUAL_FUNC_14 LT(14, KC_F20)
#define DUAL_FUNC_15 LT(13, KC_F9)
#define DUAL_FUNC_16 LT(3, KC_W)
#define DUAL_FUNC_17 LT(13, KC_F16)
#define DUAL_FUNC_18 LT(4, KC_J)
#define DUAL_FUNC_19 LT(13, KC_G)
#define DUAL_FUNC_20 LT(14, KC_L)
#define DUAL_FUNC_21 LT(10, KC_O)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN4,     KC_MS_BTN2,     NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_RIGHT_CTRL,  
    KC_LEFT_SHIFT,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_9,                                  KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RIGHT_SHIFT, 
