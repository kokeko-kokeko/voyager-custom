...
#define DUAL_FUNC_8 LT(9, KC_5)
#define DUAL_FUNC_9 LT(8, KC_R)
#define DUAL_FUNC_10 LT(12, KC_F3)
#define DUAL_FUNC_11 LT(13, KC_F18)
#define DUAL_FUNC_12 LT(7, KC_C)
#define DUAL_FUNC_13 LT(15, KC_P)
#define DUAL_FUNC_14 LT(7, KC_F5)
#define DUAL_FUNC_15 LT(7, KC_F10)
#define DUAL_FUNC_16 LT(4, KC_F5)
#define DUAL_FUNC_17 LT(11, KC_K)
#define DUAL_FUNC_18 LT(9, KC_2)
#define DUAL_FUNC_19 LT(11, KC_A)
#define DUAL_FUNC_20 LT(4, KC_4)
#define DUAL_FUNC_21 LT(12, KC_R)
#define DUAL_FUNC_22 LT(8, KC_F12)
#define DUAL_FUNC_23 LT(9, KC_F14)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [16] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN8,     KC_MS_BTN7,     KC_MS_BTN6,                                     KC_MS_BTN4,     KC_MS_BTN5,     KC_MS_BTN6,     KC_MS_BTN7,     KC_MS_BTN8,     LGUI(KC_TAB),   
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN5,                                     KC_MS_BTN3,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,     KC_MS_BTN3,                                     KC_MS_BTN1,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RIGHT_CTRL,  
