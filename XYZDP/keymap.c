...
#define DUAL_FUNC_8 LT(7, KC_F10)
#define DUAL_FUNC_9 LT(2, KC_1)
#define DUAL_FUNC_10 LT(8, KC_T)
#define DUAL_FUNC_11 LT(15, KC_X)
#define DUAL_FUNC_12 LT(6, KC_2)
#define DUAL_FUNC_13 LT(1, KC_M)
#define DUAL_FUNC_14 LT(6, KC_1)
#define DUAL_FUNC_15 LT(9, KC_W)
#define DUAL_FUNC_16 LT(15, KC_K)
#define DUAL_FUNC_17 LT(5, KC_A)
#define DUAL_FUNC_18 LT(14, KC_F10)
#define DUAL_FUNC_19 LT(5, KC_F6)
#define DUAL_FUNC_20 LT(6, KC_J)
