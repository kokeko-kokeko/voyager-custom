...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [16] = LAYOUT_voyager(
    CW_TOGG,        MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),LGUI(LCTL(KC_V)),                                KC_ESCAPE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),LGUI(KC_V),                                     KC_TRANSPARENT, MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),
    KC_LEFT_CTRL,   MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_N),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),MT(MOD_RALT | MOD_RGUI | MOD_RSFT, KC_F1),LGUI(LSFT(KC_V)),                                KC_BSPC,        MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_I),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_J),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_K),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_L),KC_RIGHT_CTRL,  
