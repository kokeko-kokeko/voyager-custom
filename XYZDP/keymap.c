...
#define DUAL_FUNC_1 LT(7, KC_F2)
#define DUAL_FUNC_2 LT(6, KC_O)
#define DUAL_FUNC_3 LT(7, KC_F24)
#define DUAL_FUNC_4 LT(10, KC_F19)
#define DUAL_FUNC_5 LT(7, KC_G)
#define DUAL_FUNC_6 LT(12, KC_F22)
#define DUAL_FUNC_7 LT(10, KC_J)
#define DUAL_FUNC_8 LT(7, KC_Q)
#define DUAL_FUNC_9 LT(5, KC_H)
#define DUAL_FUNC_10 LT(2, KC_F23)
#define DUAL_FUNC_11 LT(11, KC_F12)
#define DUAL_FUNC_12 LT(6, KC_Q)
#define DUAL_FUNC_13 LT(8, KC_F24)
#define DUAL_FUNC_14 LT(6, KC_S)
#define DUAL_FUNC_15 LT(9, KC_F22)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    LT(10, KC_B),   MT(MOD_LSFT | MOD_LCTL, KC_H),MT(MOD_LGUI | MOD_LALT, KC_I),MT(MOD_LSFT, KC_A),MT(MOD_LCTL, KC_E),KC_COMMA,                                       KC_DOT,         MT(MOD_RCTL, KC_T),MT(MOD_RSFT, KC_R),MT(MOD_RGUI | MOD_RALT, KC_S),MT(MOD_RSFT | MOD_RCTL, KC_C),LT(9, KC_V),    
    ...
    KC_LEFT_SHIFT,  KC_LEFT,        KC_RIGHT,       KC_BSPC,        LT(5, KC_SPACE),SH_T(KC_LANGUAGE_2),                            LT(4, KC_LANGUAGE_1),LT(7, KC_SPACE),SH_T(KC_DELETE),      KC_UP,          KC_DOWN,        KC_RIGHT_SHIFT, 
  ...
  [3] = LAYOUT_voyager(
    ...
    MO(10),         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN3,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(9),          
  ...
  [4] = LAYOUT_voyager(
    ...
    LT(10, KC_F11), MT(MOD_LSFT | MOD_LCTL, KC_F1),MT(MOD_LGUI | MOD_LALT, KC_F2),MT(MOD_LSFT, KC_F3),MT(MOD_LCTL, KC_F4),KC_F5,                                          KC_F6,          MT(MOD_RCTL, KC_F7),MT(MOD_RSFT, KC_F8),MT(MOD_RGUI | MOD_RALT, KC_F9),MT(MOD_RSFT | MOD_RCTL, KC_F10),LT(9, KC_F12),  
  ...
  [6] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    LT(10, KC_LBRC),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LT(9, KC_RBRC), 
  ...
  [7] = LAYOUT_voyager(
    ...
    MO(10),         LCTL(KC_A),     LCTL(KC_S),     DUAL_FUNC_12,   DUAL_FUNC_13,   KC_SCLN,                                        JP_COLN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      MO(9),          
  ...
  [21] = LAYOUT_voyager(
    ...
    HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,                                  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  
    HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,                                  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  
    KC_LEFT_SHIFT,  KC_CAPS,        KC_NO,          HSV_0_255_200,  KC_NO,          KC_NO,                                          KC_NUM,         KC_SCRL,        KC_NO,          HSV_0_255_200,  HSV_0_255_200,  HSV_0_255_200,  
