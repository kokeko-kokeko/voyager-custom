...
#define DUAL_FUNC_2 LT(10, KC_U)
#define DUAL_FUNC_3 LT(14, KC_F18)
#define DUAL_FUNC_4 LT(6, KC_F9)
#define DUAL_FUNC_5 LT(2, KC_Q)
#define DUAL_FUNC_6 LT(10, KC_F1)
#define DUAL_FUNC_7 LT(8, KC_J)
#define DUAL_FUNC_8 LT(5, KC_F7)
#define DUAL_FUNC_9 LT(10, KC_E)
#define DUAL_FUNC_10 LT(14, KC_F11)
#define DUAL_FUNC_11 LT(3, KC_6)
#define DUAL_FUNC_12 LT(5, KC_F9)
#define DUAL_FUNC_13 LT(1, KC_F12)
#define DUAL_FUNC_14 LT(7, KC_4)
#define DUAL_FUNC_15 LT(10, KC_2)
#define DUAL_FUNC_16 LT(15, KC_B)
#define DUAL_FUNC_17 LT(15, KC_F23)
#define DUAL_FUNC_18 LT(5, KC_T)
#define DUAL_FUNC_19 LT(10, KC_F18)
#define DUAL_FUNC_20 LT(3, KC_T)
#define DUAL_FUNC_21 LT(4, KC_6)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_6,  KC_MS_BTN7,     KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN2,     KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
