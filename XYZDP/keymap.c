...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    MT(MOD_LCTL, KC_B),MT(MOD_LCTL, KC_H),MT(MOD_LCTL, KC_I),MT(MOD_LCTL, KC_A),MT(MOD_LCTL, KC_E),MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_D),                                MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_H),MT(MOD_RCTL, KC_T),MT(MOD_RSFT, KC_R),MT(MOD_RGUI | MOD_RALT, KC_S),MT(MOD_RSFT | MOD_RCTL, KC_C),LT(10, KC_V),   
