...
#define DUAL_FUNC_3 LT(1, KC_H)
#define DUAL_FUNC_4 LT(4, KC_F13)
#define DUAL_FUNC_5 LT(9, KC_M)
#define DUAL_FUNC_6 LT(9, KC_V)
#define DUAL_FUNC_7 LT(15, KC_Z)
#define DUAL_FUNC_8 LT(9, KC_F17)
#define DUAL_FUNC_9 LT(14, KC_F7)
#define DUAL_FUNC_10 LT(2, KC_F11)
#define DUAL_FUNC_11 LT(8, KC_F7)
#define DUAL_FUNC_12 LT(5, KC_F14)
#define DUAL_FUNC_13 LT(11, KC_F20)
#define DUAL_FUNC_14 LT(11, KC_F15)
#define DUAL_FUNC_15 LT(6, KC_F11)
#define DUAL_FUNC_16 LT(4, KC_F24)
#define DUAL_FUNC_17 LT(7, KC_F5)
#define DUAL_FUNC_18 LT(7, KC_F23)
#define DUAL_FUNC_19 LT(6, KC_N)
#define DUAL_FUNC_20 LT(1, KC_F7)
#define DUAL_FUNC_21 LT(15, KC_X)
#define DUAL_FUNC_22 LT(11, KC_F14)
#define DUAL_FUNC_23 LT(11, KC_4)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MT(MOD_LGUI, KC_C),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, MT(MOD_RCTL, KC_H),MT(MOD_RSFT, KC_T),KC_TRANSPARENT, MT(MOD_RGUI, KC_N),KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_R,           KC_M,           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [2] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_JIGGLER_TOGGLE,KC_MS_DBL_CLICK,KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_W,           KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_LSFT, KC_E),MT(MOD_LCTL, KC_A),KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    MT(MOD_LCTL, KC_Z),MT(MOD_LCTL, KC_G),MT(MOD_LSFT, KC_X),KC_J,           KC_K,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_RCTL, KC_Q),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
