...
#define DUAL_FUNC_5 LT(1, KC_F14)
#define DUAL_FUNC_6 LT(11, KC_F12)
#define DUAL_FUNC_7 LT(7, KC_1)
#define DUAL_FUNC_8 LT(6, KC_F7)
#define DUAL_FUNC_9 LT(9, KC_C)
#define DUAL_FUNC_10 LT(7, KC_B)
#define DUAL_FUNC_11 LT(15, KC_F23)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    JP_AT,          KC_1,           MT(MOD_LALT | MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_Y),MT(MOD_LALT | MOD_LSFT, KC_O),MT(MOD_LALT | MOD_LCTL, KC_U),KC_2,                                           KC_3,           MT(MOD_RALT | MOD_RCTL, KC_D),MT(MOD_RALT | MOD_RSFT, KC_N),MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_G),KC_SLASH,       CW_TOGG,        
