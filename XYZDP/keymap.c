...
#define DUAL_FUNC_0 LT(15, KC_9)
#define DUAL_FUNC_1 LT(15, KC_J)
#define DUAL_FUNC_2 LT(15, KC_F12)
...
#define DUAL_FUNC_8 LT(8, KC_F13)
#define DUAL_FUNC_9 LT(7, KC_D)
#define DUAL_FUNC_10 LT(15, KC_F21)
#define DUAL_FUNC_11 LT(6, KC_F2)
#define DUAL_FUNC_12 LT(5, KC_F24)
#define DUAL_FUNC_13 LT(6, KC_B)
#define DUAL_FUNC_14 LT(2, KC_W)
#define DUAL_FUNC_15 LT(12, KC_W)
#define DUAL_FUNC_16 LT(5, KC_G)
#define DUAL_FUNC_17 LT(8, KC_I)
#define DUAL_FUNC_18 LT(3, KC_X)
#define DUAL_FUNC_19 LT(3, KC_T)
#define DUAL_FUNC_20 LT(5, KC_L)
#define DUAL_FUNC_21 LT(14, KC_F4)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    KC_LBRC,        KC_1,           KC_Y,           KC_O,           KC_U,           KC_2,                                           KC_3,           KC_D,           KC_N,           KC_G,           KC_SLASH,       CW_TOGG,        
