...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [8] = LAYOUT_voyager(
    ...
    KC_F11,         MT(MOD_LGUI, KC_F1),MT(MOD_LALT, KC_F2),MT(MOD_LSFT, KC_F3),MT(MOD_LCTL, KC_F4),KC_F5,                                          KC_F6,          MT(MOD_RCTL, KC_F7),MT(MOD_RSFT, KC_F8),MT(MOD_RALT, KC_F9),MT(MOD_RGUI, KC_F10),KC_TRANSPARENT, 
...
bool process_record_rgb_led_int(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case HSV_86_10_255:
      if (record->event.pressed) {
        rgblight_set_sat_noeeprom(10);
      }
      return false;
    case HSV_86_21_255:
      if (record->event.pressed) {
        rgblight_set_sat_noeeprom(21);
      }
      return false;
    case HSV_86_32_255:
      if (record->event.pressed) {
        rgblight_set_sat_noeeprom(32);
      }
      return false;
    case HSV_86_44_255:
      if (record->event.pressed) {
        rgblight_set_sat_noeeprom(44);
      }
      return false;
    case HSV_86_53_255:
      if (record->event.pressed) {
    ...
    case HSV_0_0_11:
      if (record->event.pressed) {
        rgblight_set_val_noeeprom(11);
      }
      return false;
    case HSV_0_0_21:
      if (record->event.pressed) {
        rgblight_set_val_noeeprom(21);
      }
      return false;
    case HSV_0_0_32:
      if (record->event.pressed) {
        rgblight_set_val_noeeprom(32);
      }
      return false;
    case HSV_0_0_43:
      if (record->event.pressed) {
        rgblight_set_val_noeeprom(43);
      }
      return false;
    case HSV_0_0_53:
      if (record->event.pressed) {
    ...
    case HSV_0_0_138:
      if (record->event.pressed) {
        rgblight_set_val_noeeprom(138);
      }
      return false;
    case HSV_0_0_149:
      if (record->event.pressed) {
        rgblight_set_val_noeeprom(149);
      }
      return false;
    case HSV_0_0_159:
      if (record->event.pressed) {
