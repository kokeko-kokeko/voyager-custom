...
#define DUAL_FUNC_0 LT(3, KC_F15)
#define DUAL_FUNC_1 LT(7, KC_F18)
#define DUAL_FUNC_2 LT(14, KC_Q)
#define DUAL_FUNC_3 LT(13, KC_5)
#define DUAL_FUNC_4 LT(5, KC_F19)
#define DUAL_FUNC_5 LT(14, KC_M)
#define DUAL_FUNC_6 LT(7, KC_I)
#define DUAL_FUNC_7 LT(13, KC_F14)
#define DUAL_FUNC_8 LT(7, KC_F19)
#define DUAL_FUNC_9 LT(2, KC_6)
#define DUAL_FUNC_10 LT(4, KC_Q)
#define DUAL_FUNC_11 LT(3, KC_F2)
#define DUAL_FUNC_12 LT(9, KC_8)
#define DUAL_FUNC_13 LT(12, KC_U)
#define DUAL_FUNC_14 LT(11, KC_F)
#define DUAL_FUNC_15 LT(10, KC_E)
#define DUAL_FUNC_16 LT(1, KC_V)
#define DUAL_FUNC_17 LT(4, KC_R)
#define DUAL_FUNC_18 LT(2, KC_F24)
#define DUAL_FUNC_19 LT(4, KC_F15)
#define DUAL_FUNC_20 LT(8, KC_F1)
