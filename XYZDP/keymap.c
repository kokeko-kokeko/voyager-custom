...
#define DUAL_FUNC_2 LT(13, KC_Y)
#define DUAL_FUNC_3 LT(8, KC_0)
#define DUAL_FUNC_4 LT(8, KC_2)
#define DUAL_FUNC_5 LT(1, KC_S)
#define DUAL_FUNC_6 LT(1, KC_F20)
#define DUAL_FUNC_7 LT(3, KC_F19)
#define DUAL_FUNC_8 LT(15, KC_L)
#define DUAL_FUNC_9 LT(10, KC_E)
#define DUAL_FUNC_10 LT(4, KC_E)
#define DUAL_FUNC_11 LT(2, KC_F22)
#define DUAL_FUNC_12 LT(7, KC_O)
#define DUAL_FUNC_13 LT(7, KC_F24)
#define DUAL_FUNC_14 LT(6, KC_P)
#define DUAL_FUNC_15 LT(9, KC_F20)
#define DUAL_FUNC_16 LT(2, KC_Z)
#define DUAL_FUNC_17 LT(14, KC_F14)
#define DUAL_FUNC_18 LT(9, KC_F24)
#define DUAL_FUNC_19 LT(10, KC_U)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN8,     KC_MS_BTN7,     KC_MS_BTN6,                                     KC_MS_BTN5,     KC_MS_BTN6,     KC_MS_BTN7,     KC_MS_BTN8,     KC_TRANSPARENT, KC_TRANSPARENT, 
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN5,                                     KC_MS_BTN3,     KC_MS_BTN1,     NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN4,     KC_MS_BTN2,     NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_RIGHT_CTRL,  
    KC_LEFT_SHIFT,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RIGHT_SHIFT, 
