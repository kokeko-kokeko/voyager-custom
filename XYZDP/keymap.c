...
#define DUAL_FUNC_5 LT(4, KC_B)
#define DUAL_FUNC_6 LT(2, KC_D)
#define DUAL_FUNC_7 LT(6, KC_F1)
#define DUAL_FUNC_8 LT(12, KC_U)
#define DUAL_FUNC_9 LT(2, KC_8)
#define DUAL_FUNC_10 LT(13, KC_F2)
#define DUAL_FUNC_11 LT(14, KC_N)
#define DUAL_FUNC_12 LT(5, KC_Q)
#define DUAL_FUNC_13 LT(5, KC_A)
#define DUAL_FUNC_14 LT(13, KC_W)
#define DUAL_FUNC_15 LT(8, KC_X)
#define DUAL_FUNC_16 LT(2, KC_I)
#define DUAL_FUNC_17 LT(3, KC_F21)
#define DUAL_FUNC_18 LT(6, KC_A)
#define DUAL_FUNC_19 LT(11, KC_G)
#define DUAL_FUNC_20 LT(9, KC_F16)
