...
#define DUAL_FUNC_3 LT(10, KC_X)
#define DUAL_FUNC_4 LT(8, KC_F15)
#define DUAL_FUNC_5 LT(5, KC_C)
#define DUAL_FUNC_6 LT(2, KC_H)
#define DUAL_FUNC_7 LT(9, KC_F10)
#define DUAL_FUNC_8 LT(9, KC_D)
#define DUAL_FUNC_9 LT(2, KC_F6)
#define DUAL_FUNC_10 LT(9, KC_F4)
#define DUAL_FUNC_11 LT(10, KC_F23)
#define DUAL_FUNC_12 LT(6, KC_L)
#define DUAL_FUNC_13 LT(6, KC_R)
#define DUAL_FUNC_14 LT(2, KC_1)
#define DUAL_FUNC_15 LT(7, KC_F3)
#define DUAL_FUNC_16 LT(2, KC_F14)
#define DUAL_FUNC_17 LT(7, KC_C)
#define DUAL_FUNC_18 LT(11, KC_F18)
#define DUAL_FUNC_19 LT(8, KC_F20)
#define DUAL_FUNC_20 LT(4, KC_F15)
#define DUAL_FUNC_21 LT(14, KC_F14)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_9,                                  KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
