...
#define DUAL_FUNC_6 LT(9, KC_F12)
#define DUAL_FUNC_7 LT(10, KC_I)
#define DUAL_FUNC_8 LT(12, KC_T)
#define DUAL_FUNC_9 LT(5, KC_6)
#define DUAL_FUNC_10 LT(5, KC_P)
#define DUAL_FUNC_11 LT(14, KC_1)
#define DUAL_FUNC_12 LT(4, KC_X)
#define DUAL_FUNC_13 LT(12, KC_9)
#define DUAL_FUNC_14 LT(1, KC_W)
#define DUAL_FUNC_15 LT(3, KC_I)
#define DUAL_FUNC_16 LT(4, KC_F9)
#define DUAL_FUNC_17 LT(5, KC_2)
#define DUAL_FUNC_18 LT(9, KC_K)
#define DUAL_FUNC_19 LT(6, KC_G)
#define DUAL_FUNC_20 LT(1, KC_8)
#define DUAL_FUNC_21 LT(13, KC_F14)
