...
#define DUAL_FUNC_16 LT(3, KC_F2)
#define DUAL_FUNC_17 LT(14, KC_1)
#define DUAL_FUNC_18 LT(6, KC_L)
#define DUAL_FUNC_19 LT(10, KC_U)
#define DUAL_FUNC_20 LT(8, KC_F5)
#define DUAL_FUNC_21 LT(4, KC_R)
