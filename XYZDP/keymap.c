...
#define DUAL_FUNC_1 LT(2, KC_F)
#define DUAL_FUNC_2 LT(13, KC_S)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_voyager(
    CW_TOGG,        KC_TRANSPARENT, KC_COMMA,       KC_DOT,         MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_KP_6),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_KP_6),                                MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_KP_5),MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_KP_5),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
