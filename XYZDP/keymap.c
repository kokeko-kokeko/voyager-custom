...
#define DUAL_FUNC_7 LT(8, KC_0)
#define DUAL_FUNC_8 LT(14, KC_F8)
#define DUAL_FUNC_9 LT(2, KC_F14)
#define DUAL_FUNC_10 LT(9, KC_H)
#define DUAL_FUNC_11 LT(10, KC_V)
#define DUAL_FUNC_12 LT(11, KC_Y)
#define DUAL_FUNC_13 LT(6, KC_F12)
#define DUAL_FUNC_14 LT(10, KC_X)
#define DUAL_FUNC_15 LT(14, KC_M)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    JP_AT,          KC_1,           KC_Y,           MT(MOD_LALT | MOD_LSFT, KC_O),MT(MOD_LALT | MOD_LCTL, KC_U),KC_2,                                           KC_3,           MT(MOD_RALT | MOD_RCTL, KC_D),MT(MOD_RALT | MOD_RSFT, KC_N),KC_G,           KC_SLASH,       CW_TOGG,        
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  
  {
    ...
    // Color Palette
    if (keycode == UDFN10(KC_D)) return fade_matrix_color_palette_main_keyrecord(record);
    
    if (keycode == UDFN10(KC_E)) return fade_matrix_color_palette_sel_sat_keyrecord(record);
    if (keycode == UDFN10(KC_F)) return fade_matrix_color_palette_sel_val_keyrecord(record);
    
    if (keycode == UDFN10(KC_H)) return fade_matrix_color_palette_load_preset_keyrecord(record);
