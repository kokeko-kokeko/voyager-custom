...
#define DUAL_FUNC_1 LT(15, KC_F22)
#define DUAL_FUNC_2 LT(6, KC_Y)
#define DUAL_FUNC_3 LT(4, KC_F11)
#define DUAL_FUNC_4 LT(6, KC_B)
#define DUAL_FUNC_5 LT(11, KC_F16)
#define DUAL_FUNC_6 LT(6, KC_4)
#define DUAL_FUNC_7 LT(1, KC_F9)
#define DUAL_FUNC_8 LT(2, KC_F7)
#define DUAL_FUNC_9 LT(9, KC_3)
#define DUAL_FUNC_10 LT(9, KC_N)
#define DUAL_FUNC_11 LT(3, KC_F17)
#define DUAL_FUNC_12 LT(1, KC_F15)
#define DUAL_FUNC_13 LT(8, KC_B)
#define DUAL_FUNC_14 LT(12, KC_O)
#define DUAL_FUNC_15 LT(11, KC_F13)
#define DUAL_FUNC_16 LT(11, KC_F4)
#define DUAL_FUNC_17 LT(3, KC_0)
#define DUAL_FUNC_18 LT(6, KC_K)
#define DUAL_FUNC_19 LT(1, KC_X)
#define DUAL_FUNC_20 LT(3, KC_F3)
#define DUAL_FUNC_21 LT(6, KC_Q)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN4,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RIGHT_CTRL,  
