...
#define DUAL_FUNC_13 LT(7, KC_D)
#define DUAL_FUNC_14 LT(6, KC_F19)
#define DUAL_FUNC_15 LT(9, KC_R)
...
#define DUAL_FUNC_20 LT(11, KC_V)
#define DUAL_FUNC_21 LT(4, KC_F17)
