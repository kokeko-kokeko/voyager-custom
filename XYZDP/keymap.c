...
#define DUAL_FUNC_1 LT(8, KC_F7)
#define DUAL_FUNC_2 LT(1, KC_F12)
#define DUAL_FUNC_3 LT(15, KC_F4)
#define DUAL_FUNC_4 LT(4, KC_5)
#define DUAL_FUNC_5 LT(9, KC_F10)
#define DUAL_FUNC_6 LT(14, KC_N)
#define DUAL_FUNC_7 LT(13, KC_F8)
#define DUAL_FUNC_8 LT(5, KC_P)
#define DUAL_FUNC_9 LT(10, KC_K)
#define DUAL_FUNC_10 LT(14, KC_F3)
#define DUAL_FUNC_11 LT(5, KC_F18)
#define DUAL_FUNC_12 LT(9, KC_U)
#define DUAL_FUNC_13 LT(8, KC_F9)
#define DUAL_FUNC_14 LT(13, KC_F7)
#define DUAL_FUNC_15 LT(12, KC_2)
#define DUAL_FUNC_16 LT(9, KC_F9)
#define DUAL_FUNC_17 LT(9, KC_O)
#define DUAL_FUNC_18 LT(2, KC_F9)
#define DUAL_FUNC_19 LT(8, KC_F21)
#define DUAL_FUNC_20 LT(4, KC_F18)
#define DUAL_FUNC_21 LT(10, KC_F22)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_9,                                  TOGGLE_SCROLL,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    QK_LLCK,        NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN2,                                     KC_TRANSPARENT, KC_MS_BTN1,     KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [18] = LAYOUT_voyager(
