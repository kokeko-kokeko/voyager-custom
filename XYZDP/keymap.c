...
#define DUAL_FUNC_0 LT(26, KC_F18)
#define DUAL_FUNC_1 LT(29, KC_U)
#define DUAL_FUNC_2 LT(27, KC_O)
#define DUAL_FUNC_3 LT(28, KC_F23)
#define DUAL_FUNC_4 LT(22, KC_F24)
#define DUAL_FUNC_5 LT(29, KC_I)
#define DUAL_FUNC_6 LT(24, KC_F20)
#define DUAL_FUNC_7 LT(17, KC_F7)
#define DUAL_FUNC_8 LT(22, KC_L)
#define DUAL_FUNC_9 LT(17, KC_F8)
#define DUAL_FUNC_10 LT(21, KC_0)
#define DUAL_FUNC_11 LT(23, KC_F5)
#define DUAL_FUNC_12 LT(25, KC_Z)
#define DUAL_FUNC_13 LT(22, KC_F10)
#define DUAL_FUNC_14 LT(20, KC_F)
#define DUAL_FUNC_15 LT(17, KC_F13)
#define DUAL_FUNC_16 LT(25, KC_F14)
#define DUAL_FUNC_17 LT(19, KC_F22)
#define DUAL_FUNC_18 LT(26, KC_F4)
#define DUAL_FUNC_19 LT(25, KC_F19)
#define DUAL_FUNC_20 LT(21, KC_F2)
#define DUAL_FUNC_21 LT(31, KC_8)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    ...
    LSFT(KC_B),     DUAL_FUNC_0,    DUAL_FUNC_1,    LSFT(KC_E),     DUAL_FUNC_2,    KC_SCLN,                                        KC_QUOTE,       DUAL_FUNC_5,    LSFT(KC_T),     DUAL_FUNC_6,    DUAL_FUNC_7,    LSFT(KC_V),     
    DUAL_FUNC_3,    DUAL_FUNC_4,    LSFT(KC_X),     LSFT(KC_J),     LSFT(KC_K),     LSFT(KC_INTERNATIONAL_1),                                KC_EXLM,        LSFT(KC_R),     LSFT(KC_M),     LSFT(KC_F),     DUAL_FUNC_8,    DUAL_FUNC_9,    
    KC_TRANSPARENT, KC_LEFT_GUI,    KC_LEFT_ALT,    KC_TRANSPARENT, LSFT(KC_SPACE), KC_LANGUAGE_1,                                  KC_LANGUAGE_2,  LSFT(KC_SPACE), KC_TRANSPARENT, KC_RIGHT_ALT,   KC_RIGHT_GUI,   KC_TRANSPARENT, 
                                                    LSFT(KC_TAB),   LSFT(KC_ESCAPE),                                LSFT(KC_BSPC),  LSFT(KC_ENTER)
  ),
  [4] = LAYOUT_voyager(
  ...
  [5] = LAYOUT_voyager(
    ...
    DUAL_FUNC_14,   DUAL_FUNC_15,   KC_UNDS,        KC_PLUS,        KC_COLN,        KC_LABK,                                        KC_RABK,        KC_EQUAL,       KC_CIRC,        KC_PERC,        DUAL_FUNC_16,   DUAL_FUNC_17,   
    KC_TRANSPARENT, KC_LEFT_GUI,    KC_LEFT_ALT,    KC_TRANSPARENT, KC_SPACE,       KC_LANGUAGE_2,                                  KC_LANGUAGE_1,  KC_SPACE,       KC_TRANSPARENT, KC_RIGHT_ALT,   KC_RIGHT_GUI,   KC_TRANSPARENT, 
                                                    KC_TAB,         KC_ESCAPE,                                      KC_BSPC,        KC_ENTER
  ),
  [6] = LAYOUT_voyager(
