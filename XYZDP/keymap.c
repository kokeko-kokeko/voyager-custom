...
#define DUAL_FUNC_4 LT(15, KC_F15)
#define DUAL_FUNC_5 LT(6, KC_G)
#define DUAL_FUNC_6 LT(5, KC_F4)
#define DUAL_FUNC_7 LT(14, KC_F14)
...
#define DUAL_FUNC_13 LT(5, KC_Y)
#define DUAL_FUNC_14 LT(6, KC_9)
#define DUAL_FUNC_15 LT(3, KC_F)
#define DUAL_FUNC_16 LT(3, KC_D)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    MT(MOD_LCTL, KC_Q),MT(MOD_LCTL, KC_K),MT(MOD_LSFT, KC_J),KC_X,           MT(MOD_LGUI | MOD_LCTL, KC_W),KC_MINUS,                                       KC_4,           KC_M,           KC_L,           MT(MOD_RSFT, KC_F),MT(MOD_RCTL, KC_P),MT(MOD_RCTL, KC_Z),
  ...
  [8] = LAYOUT_voyager(
    ...
    MO(10),         DUAL_FUNC_12,   DUAL_FUNC_13,   DUAL_FUNC_14,   DUAL_FUNC_15,   KC_SCLN,                                        JP_COLN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      MO(11),         
