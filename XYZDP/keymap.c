...
#define DUAL_FUNC_1 LT(3, KC_F6)
#define DUAL_FUNC_2 LT(3, KC_M)
#define DUAL_FUNC_3 LT(12, KC_M)
#define DUAL_FUNC_4 LT(2, KC_D)
...
#define DUAL_FUNC_13 LT(5, KC_F19)
#define DUAL_FUNC_14 LT(15, KC_6)
#define DUAL_FUNC_15 LT(11, KC_V)
#define DUAL_FUNC_16 LT(8, KC_Y)
#define DUAL_FUNC_17 LT(14, KC_F17)
#define DUAL_FUNC_18 LT(6, KC_F1)
#define DUAL_FUNC_19 LT(10, KC_7)
#define DUAL_FUNC_20 LT(15, KC_F23)
#define DUAL_FUNC_21 LT(14, KC_F20)
#define DUAL_FUNC_22 LT(15, KC_X)
#define DUAL_FUNC_23 LT(1, KC_2)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_R,           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_voyager(
    ...
    MT(MOD_LCTL, KC_Z),MT(MOD_LCTL, KC_G),MT(MOD_LSFT, KC_X),KC_J,           KC_K,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_M,           KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_RCTL, KC_Q),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
