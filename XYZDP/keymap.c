...
#define DUAL_FUNC_0 LT(5, KC_N)
#define DUAL_FUNC_1 LT(8, KC_O)
#define DUAL_FUNC_2 LT(6, KC_F18)
#define DUAL_FUNC_3 LT(2, KC_2)
#define DUAL_FUNC_4 LT(14, KC_Y)
#define DUAL_FUNC_5 LT(15, KC_F14)
#define DUAL_FUNC_6 LT(15, KC_F8)
#define DUAL_FUNC_7 LT(12, KC_F16)
#define DUAL_FUNC_8 LT(4, KC_S)
#define DUAL_FUNC_9 LT(5, KC_7)
#define DUAL_FUNC_10 LT(1, KC_D)
#define DUAL_FUNC_11 LT(15, KC_U)
#define DUAL_FUNC_12 LT(1, KC_M)
#define DUAL_FUNC_13 LT(9, KC_N)
#define DUAL_FUNC_14 LT(9, KC_G)
#define DUAL_FUNC_15 LT(14, KC_F19)
#define DUAL_FUNC_16 LT(5, KC_F6)
#define DUAL_FUNC_17 LT(5, KC_G)
#define DUAL_FUNC_18 LT(15, KC_O)
#define DUAL_FUNC_19 LT(4, KC_F15)
#define DUAL_FUNC_20 LT(6, KC_R)
#define DUAL_FUNC_21 LT(1, KC_E)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN7,     KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_LANGUAGE_7,  NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN6,     DRAG_SCROLL,                                    KC_MS_BTN4,     KC_MS_BTN2,     KC_MS_BTN6,     KC_MS_BTN7,     KC_MS_BTN8,     KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_6,  KC_MS_BTN3,                                     KC_LANGUAGE_8,  KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, 
