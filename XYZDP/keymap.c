...
#define DUAL_FUNC_3 LT(5, KC_3)
#define DUAL_FUNC_4 LT(5, KC_A)
#define DUAL_FUNC_5 LT(4, KC_F17)
#define DUAL_FUNC_6 LT(6, KC_F)
#define DUAL_FUNC_7 LT(1, KC_G)
#define DUAL_FUNC_8 LT(3, KC_M)
#define DUAL_FUNC_9 LT(11, KC_T)
#define DUAL_FUNC_10 LT(10, KC_B)
#define DUAL_FUNC_11 LT(7, KC_M)
#define DUAL_FUNC_12 LT(4, KC_U)
#define DUAL_FUNC_13 LT(9, KC_F23)
#define DUAL_FUNC_14 LT(13, KC_F13)
#define DUAL_FUNC_15 LT(11, KC_2)
#define DUAL_FUNC_16 LT(6, KC_F24)
#define DUAL_FUNC_17 LT(4, KC_T)
#define DUAL_FUNC_18 LT(7, KC_X)
#define DUAL_FUNC_19 LT(6, KC_F12)
