...
#define DUAL_FUNC_5 LT(15, KC_G)
#define DUAL_FUNC_6 LT(15, KC_F18)
#define DUAL_FUNC_7 LT(3, KC_V)
#define DUAL_FUNC_8 LT(6, KC_Z)
#define DUAL_FUNC_9 LT(2, KC_F18)
#define DUAL_FUNC_10 LT(11, KC_1)
#define DUAL_FUNC_11 LT(3, KC_F16)
#define DUAL_FUNC_12 LT(10, KC_C)
#define DUAL_FUNC_13 LT(5, KC_F16)
#define DUAL_FUNC_14 LT(7, KC_F19)
#define DUAL_FUNC_15 LT(2, KC_W)
#define DUAL_FUNC_16 LT(7, KC_6)
#define DUAL_FUNC_17 LT(2, KC_F1)
#define DUAL_FUNC_18 LT(3, KC_F4)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN1,     NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_LANGUAGE_8,  KC_TRANSPARENT, 
