...
#define DUAL_FUNC_15 LT(5, KC_F)
#define DUAL_FUNC_16 LT(12, KC_F23)
#define DUAL_FUNC_17 LT(3, KC_D)
#define DUAL_FUNC_18 LT(8, KC_X)
#define DUAL_FUNC_19 LT(3, KC_S)
#define DUAL_FUNC_20 LT(15, KC_F1)
#define DUAL_FUNC_21 LT(10, KC_F21)
