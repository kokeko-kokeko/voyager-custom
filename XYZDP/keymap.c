...
#define DUAL_FUNC_4 LT(14, KC_F16)
#define DUAL_FUNC_5 LT(2, KC_F20)
#define DUAL_FUNC_6 LT(12, KC_F18)
#define DUAL_FUNC_7 LT(6, KC_F8)
#define DUAL_FUNC_8 LT(6, KC_M)
#define DUAL_FUNC_9 LT(15, KC_T)
#define DUAL_FUNC_10 LT(7, KC_F6)
#define DUAL_FUNC_11 LT(6, KC_N)
#define DUAL_FUNC_12 LT(5, KC_A)
#define DUAL_FUNC_13 LT(5, KC_5)
#define DUAL_FUNC_14 LT(15, KC_C)
#define DUAL_FUNC_15 LT(4, KC_P)
#define DUAL_FUNC_16 LT(1, KC_C)
#define DUAL_FUNC_17 LT(12, KC_F10)
#define DUAL_FUNC_18 LT(13, KC_G)
#define DUAL_FUNC_19 LT(14, KC_B)
#define DUAL_FUNC_20 LT(6, KC_F24)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    ...
    MO(9),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(10),         
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, MO(5),          MO(7),                                          MO(4),          MO(7),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
