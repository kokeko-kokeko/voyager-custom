...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    LT(9, KC_B),    MT(MOD_LSFT | MOD_LCTL, KC_H),MT(MOD_LGUI | MOD_LALT, KC_I),MT(MOD_LSFT, KC_A),MT(MOD_LCTL, KC_E),MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_D),                                MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_H),MT(MOD_RCTL, KC_T),MT(MOD_RSFT, KC_R),MT(MOD_RGUI | MOD_RALT, KC_S),MT(MOD_RSFT | MOD_RCTL, KC_C),LT(10, KC_V),   
    ...
    KC_LEFT_SHIFT,  KC_LEFT,        KC_RIGHT,       KC_BSPC,        LT(3, KC_SPACE),SH_T(KC_LNG2),                                  SH_T(KC_LNG1),  LT(4, KC_SPACE),LT(6, KC_DELETE),KC_UP,          KC_DOWN,        KC_RIGHT_SHIFT, 
                                                    LT(5, KC_TAB),  LT(7, KC_ESCAPE),                                LT(8, KC_BSPC), KC_ENTER
  ),
  [1] = LAYOUT_voyager(
