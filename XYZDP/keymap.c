...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [7] = LAYOUT_voyager(
    ...
    MO(11),         MT(MOD_LCTL, KC_PAGE_UP),MT(MOD_LCTL, KC_PGDN),MT(MOD_LALT, KC_C),MT(MOD_LALT, KC_V),MT(MOD_RSFT | MOD_RCTL, KC_D),                                MT(MOD_RSFT | MOD_RCTL, KC_H),KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      MO(13),         
