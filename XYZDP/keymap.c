...
#define DUAL_FUNC_15 LT(11, KC_F6)
#define DUAL_FUNC_16 LT(12, KC_B)
#define DUAL_FUNC_17 LT(6, KC_K)
#define DUAL_FUNC_18 LT(4, KC_O)
#define DUAL_FUNC_19 LT(2, KC_F12)
#define DUAL_FUNC_20 LT(8, KC_F18)
#define DUAL_FUNC_21 LT(8, KC_F19)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [15] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN5,                                     KC_MS_BTN3,     KC_MS_BTN2,     KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_TRANSPARENT, 
    ...
    KC_LEFT_SHIFT,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(16),         KC_MS_BTN4,                                     KC_TRANSPARENT, MO(17),         KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_RIGHT_SHIFT, 
