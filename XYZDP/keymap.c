...
#define DUAL_FUNC_3 LT(8, KC_F7)
#define DUAL_FUNC_4 LT(4, KC_B)
#define DUAL_FUNC_5 LT(2, KC_I)
#define DUAL_FUNC_6 LT(6, KC_F14)
#define DUAL_FUNC_7 LT(1, KC_M)
#define DUAL_FUNC_8 LT(1, KC_F21)
#define DUAL_FUNC_9 LT(12, KC_C)
#define DUAL_FUNC_10 LT(4, KC_N)
#define DUAL_FUNC_11 LT(14, KC_T)
#define DUAL_FUNC_12 LT(8, KC_F16)
#define DUAL_FUNC_13 LT(2, KC_F21)
#define DUAL_FUNC_14 LT(12, KC_3)
#define DUAL_FUNC_15 LT(15, KC_H)
