...
#define DUAL_FUNC_1 LT(3, KC_F21)
#define DUAL_FUNC_2 LT(1, KC_0)
#define DUAL_FUNC_3 LT(9, KC_F4)
#define DUAL_FUNC_4 LT(8, KC_W)
#define DUAL_FUNC_5 LT(3, KC_K)
#define DUAL_FUNC_6 LT(11, KC_L)
#define DUAL_FUNC_7 LT(9, KC_F21)
#define DUAL_FUNC_8 LT(10, KC_F11)
#define DUAL_FUNC_9 LT(6, KC_F23)
#define DUAL_FUNC_10 LT(5, KC_F6)
#define DUAL_FUNC_11 LT(3, KC_H)
#define DUAL_FUNC_12 LT(3, KC_F5)
#define DUAL_FUNC_13 LT(2, KC_F12)
#define DUAL_FUNC_14 LT(12, KC_C)
#define DUAL_FUNC_15 LT(10, KC_F7)
#define DUAL_FUNC_16 LT(6, KC_1)
#define DUAL_FUNC_17 LT(7, KC_F11)
#define DUAL_FUNC_18 LT(2, KC_A)
#define DUAL_FUNC_19 LT(2, KC_F14)
#define DUAL_FUNC_20 LT(14, KC_E)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN4,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_2,                                  KC_LANGUAGE_1,  KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
