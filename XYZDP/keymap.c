...
#define DUAL_FUNC_8 LT(14, KC_F1)
#define DUAL_FUNC_9 LT(2, KC_O)
#define DUAL_FUNC_10 LT(2, KC_F12)
#define DUAL_FUNC_11 LT(11, KC_F17)
#define DUAL_FUNC_12 LT(6, KC_H)
#define DUAL_FUNC_13 LT(5, KC_R)
#define DUAL_FUNC_14 LT(9, KC_J)
#define DUAL_FUNC_15 LT(11, KC_T)
#define DUAL_FUNC_16 LT(14, KC_F17)
#define DUAL_FUNC_17 LT(2, KC_F5)
#define DUAL_FUNC_18 LT(12, KC_7)
#define DUAL_FUNC_19 LT(5, KC_F11)
#define DUAL_FUNC_20 LT(5, KC_F13)
