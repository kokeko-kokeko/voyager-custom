...
#define DUAL_FUNC_2 LT(7, KC_F10)
#define DUAL_FUNC_3 LT(10, KC_F6)
#define DUAL_FUNC_4 LT(13, KC_T)
#define DUAL_FUNC_5 LT(13, KC_F14)
#define DUAL_FUNC_6 LT(4, KC_K)
#define DUAL_FUNC_7 LT(3, KC_T)
#define DUAL_FUNC_8 LT(3, KC_8)
#define DUAL_FUNC_9 LT(12, KC_F23)
#define DUAL_FUNC_10 LT(13, KC_F22)
#define DUAL_FUNC_11 LT(3, KC_F22)
#define DUAL_FUNC_12 LT(2, KC_M)
#define DUAL_FUNC_13 LT(8, KC_F8)
#define DUAL_FUNC_14 LT(4, KC_F24)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, MT(MOD_RALT | MOD_RCTL, KC_L),MT(MOD_RALT | MOD_RSFT, KC_D),KC_W,           KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    MT(MOD_LCTL, KC_Z),MT(MOD_LCTL, KC_G),MT(MOD_LSFT, KC_X),KC_J,           KC_K,           KC_TRANSPARENT,                                 KC_TRANSPARENT, MT(MOD_RGUI | MOD_RCTL, KC_N),MT(MOD_RGUI | MOD_RSFT, KC_M),KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_RCTL, KC_Q),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
