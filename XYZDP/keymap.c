...
#define DUAL_FUNC_0 LT(7, KC_4)
#define DUAL_FUNC_1 LT(7, KC_Y)
#define DUAL_FUNC_2 LT(5, KC_F21)
#define DUAL_FUNC_3 LT(7, KC_D)
#define DUAL_FUNC_4 LT(5, KC_N)
#define DUAL_FUNC_5 LT(9, KC_F14)
#define DUAL_FUNC_6 LT(1, KC_F16)
#define DUAL_FUNC_7 LT(6, KC_Z)
#define DUAL_FUNC_8 LT(5, KC_M)
#define DUAL_FUNC_9 LT(12, KC_6)
#define DUAL_FUNC_10 LT(10, KC_6)
#define DUAL_FUNC_11 LT(3, KC_T)
#define DUAL_FUNC_12 LT(12, KC_1)
#define DUAL_FUNC_13 LT(13, KC_F4)
#define DUAL_FUNC_14 LT(4, KC_F12)
#define DUAL_FUNC_15 LT(10, KC_N)
#define DUAL_FUNC_16 LT(2, KC_8)
#define DUAL_FUNC_17 LT(8, KC_F20)
#define DUAL_FUNC_18 LT(8, KC_3)
#define DUAL_FUNC_19 LT(14, KC_C)
#define DUAL_FUNC_20 LT(5, KC_F10)
#define DUAL_FUNC_21 LT(10, KC_F4)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [22] = LAYOUT_voyager(
    ...
    HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,                                   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   
    HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,                                   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   HSV_0_255_23,   
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, HSV_172_255_2
  ),
  [23] = LAYOUT_voyager(
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  case NAVIGATOR_DEC_CPI:
    ...
    case HSV_86_255_3:
      if (record->event.pressed) {
        rgblight_mode(1);
        rgblight_sethsv(86,255,3);
      }
      return false;
    case HSV_86_255_4:
      if (record->event.pressed) {
        rgblight_mode(1);
        rgblight_sethsv(86,255,4);
      }
      return false;
    case HSV_86_255_255:
      if (record->event.pressed) {
    ...
    case HSV_172_255_1:
      if (record->event.pressed) {
        rgblight_mode(1);
        rgblight_sethsv(172,255,1);
      }
      return false;
    case HSV_0_255_21:
      if (record->event.pressed) {
        rgblight_mode(1);
        rgblight_sethsv(0,255,21);
      }
      return false;
    case HSV_86_255_5:
      if (record->event.pressed) {
        rgblight_mode(1);
        rgblight_sethsv(86,255,5);
      }
      return false;
    case HSV_0_255_22:
      if (record->event.pressed) {
        rgblight_mode(1);
        rgblight_sethsv(0,255,22);
      }
      return false;
    case HSV_86_255_6:
      if (record->event.pressed) {
