...
#define DUAL_FUNC_9 LT(7, KC_A)
#define DUAL_FUNC_10 LT(7, KC_F22)
#define DUAL_FUNC_11 LT(6, KC_W)
#define DUAL_FUNC_12 LT(7, KC_F)
#define DUAL_FUNC_13 LT(4, KC_F15)
#define DUAL_FUNC_14 LT(12, KC_G)
#define DUAL_FUNC_15 LT(1, KC_F23)
#define DUAL_FUNC_16 LT(11, KC_J)
#define DUAL_FUNC_17 LT(3, KC_B)
#define DUAL_FUNC_18 LT(14, KC_O)
#define DUAL_FUNC_19 LT(15, KC_5)
#define DUAL_FUNC_20 LT(14, KC_F6)
#define DUAL_FUNC_21 LT(4, KC_I)
