...
#define DUAL_FUNC_7 LT(12, KC_F6)
#define DUAL_FUNC_8 LT(3, KC_R)
#define DUAL_FUNC_9 LT(12, KC_L)
#define DUAL_FUNC_10 LT(4, KC_S)
#define DUAL_FUNC_11 LT(12, KC_H)
#define DUAL_FUNC_12 LT(5, KC_F23)
#define DUAL_FUNC_13 LT(2, KC_T)
#define DUAL_FUNC_14 LT(5, KC_B)
#define DUAL_FUNC_15 LT(13, KC_S)
#define DUAL_FUNC_16 LT(5, KC_F4)
#define DUAL_FUNC_17 LT(6, KC_F21)
#define DUAL_FUNC_18 LT(12, KC_M)
#define DUAL_FUNC_19 LT(4, KC_5)
