...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_F1),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_F2),KC_Y,           MT(MOD_LALT | MOD_LSFT, KC_O),MT(MOD_LALT | MOD_LCTL, KC_U),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_F3),                                MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_F7),MT(MOD_RALT | MOD_RCTL, KC_D),MT(MOD_RALT | MOD_RSFT, KC_N),KC_G,           MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_F6),CW_TOGG,        
    LT(9, KC_B),    MT(MOD_LSFT | MOD_LCTL, KC_H),MT(MOD_LGUI | MOD_LALT, KC_I),MT(MOD_LSFT, KC_A),MT(MOD_LCTL, KC_E),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_F4),                                MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_F8),MT(MOD_RCTL, KC_T),MT(MOD_RSFT, KC_R),MT(MOD_RGUI | MOD_RALT, KC_S),MT(MOD_RSFT | MOD_RCTL, KC_C),LT(10, KC_V),   
    MT(MOD_LCTL, KC_Q),MT(MOD_LGUI, KC_K),MT(MOD_LALT, KC_J),MT(MOD_LGUI | MOD_LSFT, KC_X),MT(MOD_LGUI | MOD_LCTL, KC_W),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_F5),                                MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_F9),MT(MOD_RGUI | MOD_RCTL, KC_M),MT(MOD_RGUI | MOD_RSFT, KC_L),MT(MOD_RALT, KC_F),MT(MOD_RGUI, KC_P),MT(MOD_RCTL, KC_Z),
  ...
  [3] = LAYOUT_voyager(
    CW_TOGG,        KC_TRANSPARENT, MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_COMMA),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_DOT),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_KP_6),MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_KP_6),                                MT(MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_KP_5),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_KP_5),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_KP_DOT),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_KP_COMMA),KC_TRANSPARENT, KC_TRANSPARENT, 
    MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_L),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_1),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_2),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_3),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_4),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_5),                                MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_6),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_7),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_8),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_9),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_0),MT(MOD_LGUI | MOD_LSFT | MOD_LCTL, KC_R),
    MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_L),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_1),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_2),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_3),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_4),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_5),                                MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_6),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_7),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_8),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_9),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_0),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_R),
  ...
  [4] = LAYOUT_voyager(
    CW_TOGG,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_F3),                                MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_F7),LCTL(KC_V),     KC_UP,          LCTL(KC_C),     KC_APPLICATION, KC_BSPC,        
    MO(9),          MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_A),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_B),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_C),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_D),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_F4),                                MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_F8),KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      MO(10),         
    KC_LEFT_CTRL,   MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_E),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_F),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_G),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_H),MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_F5),                                MT(MOD_LGUI | MOD_LSFT | MOD_RCTL, KC_F9),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_I),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_J),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_K),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_L),KC_RIGHT_CTRL,  
  ...
  [16] = LAYOUT_voyager(
    CW_TOGG,        MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),LGUI(LCTL(KC_V)),                                KC_ESCAPE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),LGUI(KC_V),                                     KC_TRANSPARENT, MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),
    KC_LEFT_CTRL,   MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_M),MT(MOD_LALT | MOD_LGUI | MOD_LCTL, KC_N),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),MT(MOD_RALT | MOD_RSFT | MOD_RCTL, KC_F1),LGUI(LSFT(KC_V)),                                KC_BSPC,        MT(MOD_RALT | MOD_RGUI | MOD_RCTL, KC_I),MT(MOD_RALT | MOD_RGUI | MOD_RCTL, KC_J),MT(MOD_RALT | MOD_RGUI | MOD_RCTL, KC_K),MT(MOD_RALT | MOD_RGUI | MOD_RCTL, KC_L),KC_RIGHT_CTRL,  
