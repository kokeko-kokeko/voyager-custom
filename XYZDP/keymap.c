...
#define DUAL_FUNC_3 LT(2, KC_F23)
#define DUAL_FUNC_4 LT(4, KC_F10)
#define DUAL_FUNC_5 LT(2, KC_F22)
#define DUAL_FUNC_6 LT(12, KC_F21)
#define DUAL_FUNC_7 LT(5, KC_5)
#define DUAL_FUNC_8 LT(1, KC_F23)
#define DUAL_FUNC_9 LT(3, KC_F18)
#define DUAL_FUNC_10 LT(14, KC_F10)
#define DUAL_FUNC_11 LT(13, KC_F23)
#define DUAL_FUNC_12 LT(12, KC_3)
#define DUAL_FUNC_13 LT(9, KC_A)
#define DUAL_FUNC_14 LT(2, KC_W)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    CW_TOGG,        KC_TRANSPARENT, KC_COMMA,       KC_DOT,         KC_6,           KC_RABK,                                        KC_5,           KC_KP_PLUS,     KC_KP_MINUS,    KC_KP_ASTERISK, KC_KP_SLASH,    KC_KP_EQUAL,    
