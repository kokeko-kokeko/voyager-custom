...
#define DUAL_FUNC_0 LT(10, KC_7)
#define DUAL_FUNC_1 LT(15, KC_H)
#define DUAL_FUNC_2 LT(5, KC_F4)
#define DUAL_FUNC_3 LT(15, KC_S)
#define DUAL_FUNC_4 LT(1, KC_F19)
#define DUAL_FUNC_5 LT(7, KC_W)
#define DUAL_FUNC_6 LT(10, KC_F9)
#define DUAL_FUNC_7 LT(4, KC_F7)
#define DUAL_FUNC_8 LT(7, KC_4)
#define DUAL_FUNC_9 LT(3, KC_D)
#define DUAL_FUNC_10 LT(7, KC_9)
#define DUAL_FUNC_11 LT(8, KC_E)
#define DUAL_FUNC_12 LT(8, KC_X)
#define DUAL_FUNC_13 LT(14, KC_N)
#define DUAL_FUNC_14 LT(13, KC_M)
#define DUAL_FUNC_15 LT(13, KC_F1)
#define DUAL_FUNC_16 LT(2, KC_N)
#define DUAL_FUNC_17 LT(3, KC_F12)
#define DUAL_FUNC_18 LT(1, KC_F22)
#define DUAL_FUNC_19 LT(12, KC_F)
#define DUAL_FUNC_20 LT(4, KC_S)
#define DUAL_FUNC_21 LT(14, KC_C)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN8,     KC_MS_BTN5,                                     KC_MS_BTN4,     KC_MS_BTN5,     KC_MS_BTN6,     KC_MS_BTN7,     KC_MS_BTN8,     KC_TRANSPARENT, 
    ...
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN6,     DRAG_SCROLL,                                    LGUI(KC_TAB),   KC_MS_BTN1,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RIGHT_CTRL,  
