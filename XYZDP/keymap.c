...
#define DUAL_FUNC_2 LT(4, KC_E)
#define DUAL_FUNC_3 LT(10, KC_G)
#define DUAL_FUNC_4 LT(3, KC_2)
#define DUAL_FUNC_5 LT(4, KC_X)
#define DUAL_FUNC_6 LT(12, KC_Z)
#define DUAL_FUNC_7 LT(14, KC_X)
#define DUAL_FUNC_8 LT(2, KC_X)
#define DUAL_FUNC_9 LT(13, KC_F2)
#define DUAL_FUNC_10 LT(11, KC_X)
#define DUAL_FUNC_11 LT(15, KC_H)
#define DUAL_FUNC_12 LT(14, KC_0)
#define DUAL_FUNC_13 LT(10, KC_R)
#define DUAL_FUNC_14 LT(10, KC_Y)
#define DUAL_FUNC_15 LT(10, KC_1)
#define DUAL_FUNC_16 LT(6, KC_W)
#define DUAL_FUNC_17 LT(7, KC_F13)
#define DUAL_FUNC_18 LT(1, KC_F24)
#define DUAL_FUNC_19 LT(7, KC_F10)
#define DUAL_FUNC_20 LT(2, KC_H)
#define DUAL_FUNC_21 LT(9, KC_F18)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_6,  KC_MS_BTN7,     KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN6,     DRAG_SCROLL,                                    KC_MS_BTN4,     KC_MS_BTN2,     KC_MS_BTN6,     KC_MS_BTN7,     KC_MS_BTN8,     KC_RIGHT_CTRL,  
