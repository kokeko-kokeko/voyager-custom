...
#define DUAL_FUNC_1 LT(6, KC_P)
#define DUAL_FUNC_2 LT(3, KC_F2)
#define DUAL_FUNC_3 LT(7, KC_9)
#define DUAL_FUNC_4 LT(2, KC_F4)
#define DUAL_FUNC_5 LT(10, KC_F15)
#define DUAL_FUNC_6 LT(9, KC_C)
#define DUAL_FUNC_7 LT(14, KC_N)
#define DUAL_FUNC_8 LT(5, KC_F18)
#define DUAL_FUNC_9 LT(7, KC_D)
#define DUAL_FUNC_10 LT(9, KC_F7)
#define DUAL_FUNC_11 LT(5, KC_F)
#define DUAL_FUNC_12 LT(3, KC_D)
#define DUAL_FUNC_13 LT(13, KC_G)
#define DUAL_FUNC_14 LT(5, KC_F1)
#define DUAL_FUNC_15 LT(2, KC_X)
#define DUAL_FUNC_16 LT(4, KC_N)
#define DUAL_FUNC_17 LT(3, KC_F10)
#define DUAL_FUNC_18 LT(9, KC_F18)
#define DUAL_FUNC_19 LT(6, KC_F5)
#define DUAL_FUNC_20 LT(1, KC_B)
#define DUAL_FUNC_21 LT(5, KC_J)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_TURBO,
