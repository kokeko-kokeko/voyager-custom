...
#define DUAL_FUNC_2 LT(5, KC_W)
#define DUAL_FUNC_3 LT(5, KC_F2)
#define DUAL_FUNC_4 LT(15, KC_S)
#define DUAL_FUNC_5 LT(4, KC_W)
#define DUAL_FUNC_6 LT(10, KC_T)
#define DUAL_FUNC_7 LT(7, KC_F17)
#define DUAL_FUNC_8 LT(6, KC_F20)
#define DUAL_FUNC_9 LT(10, KC_F16)
...
#define DUAL_FUNC_15 LT(6, KC_A)
#define DUAL_FUNC_16 LT(8, KC_3)
#define DUAL_FUNC_17 LT(13, KC_F2)
#define DUAL_FUNC_18 LT(7, KC_F11)
#define DUAL_FUNC_19 LT(4, KC_A)
#define DUAL_FUNC_20 LT(10, KC_F24)
#define DUAL_FUNC_21 LT(14, KC_3)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [18] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LCTL(KC_C),     LCTL(KC_V),     KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
