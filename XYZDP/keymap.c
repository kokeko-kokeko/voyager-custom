...
#define DUAL_FUNC_0 LT(1, KC_7)
#define DUAL_FUNC_1 LT(9, KC_1)
#define DUAL_FUNC_2 LT(6, KC_F17)
#define DUAL_FUNC_3 LT(11, KC_3)
#define DUAL_FUNC_4 LT(1, KC_F15)
#define DUAL_FUNC_5 LT(7, KC_M)
#define DUAL_FUNC_6 LT(8, KC_5)
#define DUAL_FUNC_7 LT(2, KC_9)
#define DUAL_FUNC_8 LT(8, KC_F17)
#define DUAL_FUNC_9 LT(13, KC_X)
#define DUAL_FUNC_10 LT(1, KC_Z)
#define DUAL_FUNC_11 LT(12, KC_F6)
#define DUAL_FUNC_12 LT(10, KC_Z)
#define DUAL_FUNC_13 LT(12, KC_P)
#define DUAL_FUNC_14 LT(14, KC_F21)
#define DUAL_FUNC_15 LT(1, KC_F18)
#define DUAL_FUNC_16 LT(7, KC_F19)
#define DUAL_FUNC_17 LT(9, KC_F3)
#define DUAL_FUNC_18 LT(13, KC_A)
#define DUAL_FUNC_19 LT(10, KC_5)
#define DUAL_FUNC_20 LT(13, KC_F20)
#define DUAL_FUNC_21 LT(6, KC_F24)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN5,                                     KC_MS_BTN5,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN4,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_9,                                  KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
