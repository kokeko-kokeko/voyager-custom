...
#define DUAL_FUNC_0 LT(10, KC_P)
#define DUAL_FUNC_1 LT(7, KC_F7)
#define DUAL_FUNC_2 LT(3, KC_L)
#define DUAL_FUNC_3 LT(11, KC_F18)
#define DUAL_FUNC_4 LT(2, KC_H)
#define DUAL_FUNC_5 LT(7, KC_Y)
#define DUAL_FUNC_6 LT(6, KC_F11)
#define DUAL_FUNC_7 LT(3, KC_O)
#define DUAL_FUNC_8 LT(11, KC_O)
#define DUAL_FUNC_9 LT(15, KC_7)
#define DUAL_FUNC_10 LT(13, KC_F)
#define DUAL_FUNC_11 LT(5, KC_F18)
#define DUAL_FUNC_12 LT(1, KC_7)
#define DUAL_FUNC_13 LT(11, KC_F15)
#define DUAL_FUNC_14 LT(13, KC_B)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LT(3, KC_SPACE),KC_TRANSPARENT,                                 KC_TRANSPARENT, LT(5, KC_SPACE),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, TD(DANCE_2),                                    TD(DANCE_3),    KC_TRANSPARENT
  ),
  [2] = LAYOUT_voyager(
