...
#define DUAL_FUNC_3 LT(6, KC_F9)
#define DUAL_FUNC_4 LT(4, KC_F12)
#define DUAL_FUNC_5 LT(10, KC_F19)
#define DUAL_FUNC_6 LT(7, KC_Z)
#define DUAL_FUNC_7 LT(14, KC_7)
#define DUAL_FUNC_8 LT(8, KC_P)
#define DUAL_FUNC_9 LT(5, KC_Z)
#define DUAL_FUNC_10 LT(15, KC_F1)
#define DUAL_FUNC_11 LT(5, KC_F7)
#define DUAL_FUNC_12 LT(14, KC_D)
#define DUAL_FUNC_13 LT(15, KC_F)
#define DUAL_FUNC_14 LT(8, KC_M)
#define DUAL_FUNC_15 LT(11, KC_F5)
#define DUAL_FUNC_16 LT(2, KC_F4)
#define DUAL_FUNC_17 LT(15, KC_F7)
#define DUAL_FUNC_18 LT(13, KC_F11)
#define DUAL_FUNC_19 LT(12, KC_A)
#define DUAL_FUNC_20 LT(15, KC_6)
#define DUAL_FUNC_21 LT(15, KC_N)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_LEFT,        KC_RIGHT,       KC_BSPC,        LT(5, KC_SPACE),LT(7, KC_LANGUAGE_2),                                LT(4, KC_LANGUAGE_1),LT(7, KC_SPACE),KC_DELETE,      KC_UP,          KC_DOWN,        KC_RIGHT_SHIFT, 
                                                    LT(4, KC_TAB),  LT(3, KC_ESCAPE),                                LT(5, KC_BSPC), KC_ENTER
  ),
  [1] = LAYOUT_voyager(
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(5),          MO(7),                                          MO(4),          MO(7),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    MO(4),          MO(3),                                          MO(5),          KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    MO(9),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(10),         
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(5),          KC_LANGUAGE_2,                                  KC_LANGUAGE_1,  MO(7),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    MO(4),          KC_TRANSPARENT,                                 MO(5),          KC_TRANSPARENT
  ),
  [4] = LAYOUT_voyager(
  ...
  [5] = LAYOUT_voyager(
    ...
    LT(9, KC_LBRC), MT(MOD_LGUI, KC_1),MT(MOD_LALT, KC_2),MT(MOD_LSFT, KC_3),MT(MOD_LCTL, KC_4),KC_5,                                           KC_6,           MT(MOD_RCTL, KC_7),MT(MOD_RSFT, KC_8),MT(MOD_RALT, KC_9),MT(MOD_RGUI, KC_0),LT(10, KC_RBRC),
  ...
  [6] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    LT(9, KC_RBRC), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LT(10, KC_BSLS),
  ...
  [7] = LAYOUT_voyager(
    ...
    MO(9),          DUAL_FUNC_10,   DUAL_FUNC_11,   DUAL_FUNC_12,   DUAL_FUNC_13,   KC_SCLN,                                        KC_COLN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      MO(10),         
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN8,     KC_MS_BTN5,                                     KC_TRANSPARENT, KC_MS_BTN5,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_6,  KC_MS_BTN7,     KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN2,     KC_LANGUAGE_8,  NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN6,     DRAG_SCROLL,                                    KC_MS_BTN4,     KC_MS_BTN1,     KC_MS_BTN6,     KC_MS_BTN7,     KC_MS_BTN8,     KC_RIGHT_CTRL,  
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_7,  KC_MS_BTN3,                                     KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, 
  ...
  [18] = LAYOUT_voyager(
    ...
    QK_DYNAMIC_TAPPING_TERM_PRINT,QK_DYNAMIC_TAPPING_TERM_DOWN,QK_DYNAMIC_TAPPING_TERM_UP,KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          HSV_215_255_149,
...
void post_process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  if (is_auto_mouse_active()) {
    switch (keycode) {
      ...
      case KC_MS_BTN8:
        if (record->event.key.row < MATRIX_ROWS / 2) {
           static uint16_t mouse_button_press_time_left[8];
          // left side mouse button
          if (record->event.pressed) {
            //navigator_aim = true;
            mouse_button_press_time_left[keycode - KC_MS_BTN1] = record->event.time;
            // early trigger reset on auto_mouse_activation
          } else {
            //navigator_aim = false;
            uint16_t mouse_button_duration = record->event.time - mouse_button_press_time_left[keycode - KC_MS_BTN1];
          ...
          static uint16_t mouse_button_press_time_right[8];
          // right side mouse button
          if (record->event.pressed) {
            //navigator_turbo = true;
            mouse_button_press_time_right[keycode - KC_MS_BTN1] = record->event.time;
            // early trigger reset on auto_mouse_activation
          } else {
            //navigator_turbo = false;
            uint16_t mouse_button_duration = record->event.time - mouse_button_press_time_right[keycode - KC_MS_BTN1];
            if (mouse_button_duration < AUTO_MOUSE_DRAG_THRESHOLD) {
              fast_timer_t now = timer_read_fast();
