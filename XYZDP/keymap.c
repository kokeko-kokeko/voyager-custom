...
#define DUAL_FUNC_6 LT(4, KC_F3)
#define DUAL_FUNC_7 LT(2, KC_F2)
#define DUAL_FUNC_8 LT(12, KC_0)
#define DUAL_FUNC_9 LT(8, KC_F23)
#define DUAL_FUNC_10 LT(2, KC_W)
#define DUAL_FUNC_11 LT(14, KC_F12)
#define DUAL_FUNC_12 LT(14, KC_F23)
...
static const uint8_t * const led_pattern_on = (uint8_t[]){13, 0, UINT8_MAX, UINT8_MAX, UINT8_MAX};
