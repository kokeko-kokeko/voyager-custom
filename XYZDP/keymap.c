...
#define DUAL_FUNC_2 LT(8, KC_W)
#define DUAL_FUNC_3 LT(14, KC_L)
#define DUAL_FUNC_4 LT(1, KC_F12)
#define DUAL_FUNC_5 LT(1, KC_K)
#define DUAL_FUNC_6 LT(1, KC_E)
#define DUAL_FUNC_7 LT(12, KC_S)
#define DUAL_FUNC_8 LT(9, KC_F14)
#define DUAL_FUNC_9 LT(14, KC_0)
#define DUAL_FUNC_10 LT(7, KC_C)
#define DUAL_FUNC_11 LT(7, KC_F10)
#define DUAL_FUNC_12 LT(5, KC_A)
#define DUAL_FUNC_13 LT(7, KC_T)
#define DUAL_FUNC_14 LT(8, KC_F5)
#define DUAL_FUNC_15 LT(13, KC_A)
#define DUAL_FUNC_16 LT(6, KC_F21)
#define DUAL_FUNC_17 LT(9, KC_A)
#define DUAL_FUNC_18 LT(10, KC_F4)
#define DUAL_FUNC_19 LT(4, KC_2)
#define DUAL_FUNC_20 LT(7, KC_F16)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN8,     KC_MS_BTN7,     KC_MS_BTN6,     KC_MS_BTN5,                                     KC_MS_BTN5,     KC_MS_BTN6,     KC_MS_BTN7,     KC_MS_BTN8,     KC_TRANSPARENT, KC_TRANSPARENT, 
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN1,     NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DRAG_SCROLL,                                    KC_MS_BTN4,     KC_MS_BTN2,     NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_RIGHT_CTRL,  
    KC_LEFT_SHIFT,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_9,  KC_MS_BTN3,                                     KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RIGHT_SHIFT, 
