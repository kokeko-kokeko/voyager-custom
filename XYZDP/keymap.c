...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    MO(18),         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     RCTL(KC_MS_BTN1),RSFT(KC_MS_BTN1),RALT(KC_MS_BTN1),RGUI(KC_MS_BTN1),MO(19),         
