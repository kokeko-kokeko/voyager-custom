...
#define DUAL_FUNC_3 LT(14, KC_6)
#define DUAL_FUNC_4 LT(12, KC_G)
#define DUAL_FUNC_5 LT(6, KC_F11)
#define DUAL_FUNC_6 LT(8, KC_4)
#define DUAL_FUNC_7 LT(13, KC_U)
#define DUAL_FUNC_8 LT(9, KC_F15)
#define DUAL_FUNC_9 LT(3, KC_F1)
#define DUAL_FUNC_10 LT(14, KC_E)
#define DUAL_FUNC_11 LT(4, KC_S)
#define DUAL_FUNC_12 LT(10, KC_Z)
#define DUAL_FUNC_13 LT(10, KC_A)
#define DUAL_FUNC_14 LT(2, KC_3)
#define DUAL_FUNC_15 LT(13, KC_5)
#define DUAL_FUNC_16 LT(7, KC_X)
#define DUAL_FUNC_17 LT(5, KC_F9)
#define DUAL_FUNC_18 LT(9, KC_6)
#define DUAL_FUNC_19 LT(6, KC_Y)
#define DUAL_FUNC_20 LT(12, KC_F22)
#define DUAL_FUNC_21 LT(2, KC_C)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_LANGUAGE_7,  NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_6,  KC_MS_BTN3,                                     KC_LANGUAGE_8,  DRAG_SCROLL,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
