...
#define DUAL_FUNC_2 LT(8, KC_F10)
#define DUAL_FUNC_3 LT(3, KC_H)
#define DUAL_FUNC_4 LT(8, KC_6)
#define DUAL_FUNC_5 LT(8, KC_F5)
#define DUAL_FUNC_6 LT(12, KC_J)
#define DUAL_FUNC_7 LT(5, KC_R)
#define DUAL_FUNC_8 LT(7, KC_F18)
#define DUAL_FUNC_9 LT(14, KC_F12)
#define DUAL_FUNC_10 LT(5, KC_C)
#define DUAL_FUNC_11 LT(1, KC_R)
#define DUAL_FUNC_12 LT(15, KC_F19)
#define DUAL_FUNC_13 LT(13, KC_0)
#define DUAL_FUNC_14 LT(12, KC_D)
#define DUAL_FUNC_15 LT(15, KC_N)
#define DUAL_FUNC_16 LT(6, KC_N)
#define DUAL_FUNC_17 LT(9, KC_F13)
#define DUAL_FUNC_18 LT(7, KC_8)
#define DUAL_FUNC_19 LT(3, KC_X)
#define DUAL_FUNC_20 LT(8, KC_L)
#define DUAL_FUNC_21 LT(7, KC_E)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [6] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_TRANSPARENT, KC_MS_BTN1,     KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,QK_LLCK,        
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [7] = LAYOUT_voyager(
