...
#define DUAL_FUNC_2 LT(14, KC_8)
#define DUAL_FUNC_3 LT(7, KC_F17)
#define DUAL_FUNC_4 LT(12, KC_A)
#define DUAL_FUNC_5 LT(14, KC_F20)
#define DUAL_FUNC_6 LT(4, KC_F18)
#define DUAL_FUNC_7 LT(12, KC_B)
#define DUAL_FUNC_8 LT(13, KC_F9)
#define DUAL_FUNC_9 LT(9, KC_F19)
#define DUAL_FUNC_10 LT(7, KC_I)
#define DUAL_FUNC_11 LT(1, KC_F24)
#define DUAL_FUNC_12 LT(14, KC_1)
#define DUAL_FUNC_13 LT(5, KC_F)
#define DUAL_FUNC_14 LT(2, KC_9)
#define DUAL_FUNC_15 LT(15, KC_8)
#define DUAL_FUNC_16 LT(4, KC_B)
#define DUAL_FUNC_17 LT(13, KC_F7)
#define DUAL_FUNC_18 LT(6, KC_F)
#define DUAL_FUNC_19 LT(2, KC_C)
#define DUAL_FUNC_20 LT(10, KC_E)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN5,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_TRANSPARENT, 
