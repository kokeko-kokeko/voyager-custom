...
#define DUAL_FUNC_1 LT(5, KC_K)
#define DUAL_FUNC_2 LT(4, KC_P)
#define DUAL_FUNC_3 LT(10, KC_T)
#define DUAL_FUNC_4 LT(4, KC_K)
#define DUAL_FUNC_5 LT(3, KC_O)
#define DUAL_FUNC_6 LT(2, KC_S)
#define DUAL_FUNC_7 LT(8, KC_F20)
#define DUAL_FUNC_8 LT(2, KC_1)
#define DUAL_FUNC_9 LT(15, KC_F8)
#define DUAL_FUNC_10 LT(12, KC_K)
#define DUAL_FUNC_11 LT(13, KC_F15)
#define DUAL_FUNC_12 LT(15, KC_F15)
#define DUAL_FUNC_13 LT(15, KC_Y)
#define DUAL_FUNC_14 LT(3, KC_F21)
#define DUAL_FUNC_15 LT(8, KC_F2)
#define DUAL_FUNC_16 LT(11, KC_X)
#define DUAL_FUNC_17 LT(12, KC_F22)
#define DUAL_FUNC_18 LT(14, KC_F24)
#define DUAL_FUNC_19 LT(14, KC_P)
#define DUAL_FUNC_20 LT(3, KC_J)
#define DUAL_FUNC_21 LT(2, KC_H)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_9,                                  KC_MS_BTN4,     KC_MS_BTN2,     NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_RIGHT_CTRL,  
