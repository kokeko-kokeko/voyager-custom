...
#define DUAL_FUNC_0 LT(1, KC_F19)
#define DUAL_FUNC_1 LT(12, KC_0)
#define DUAL_FUNC_2 LT(4, KC_6)
#define DUAL_FUNC_3 LT(1, KC_B)
#define DUAL_FUNC_4 LT(6, KC_A)
#define DUAL_FUNC_5 LT(4, KC_N)
#define DUAL_FUNC_6 LT(5, KC_F16)
#define DUAL_FUNC_7 LT(1, KC_7)
#define DUAL_FUNC_8 LT(12, KC_F1)
#define DUAL_FUNC_9 LT(10, KC_W)
#define DUAL_FUNC_10 LT(5, KC_F19)
#define DUAL_FUNC_11 LT(2, KC_F3)
#define DUAL_FUNC_12 LT(3, KC_F10)
#define DUAL_FUNC_13 LT(7, KC_F1)
#define DUAL_FUNC_14 LT(2, KC_6)
#define DUAL_FUNC_15 LT(15, KC_F6)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    LT(7, KC_B),    MT(MOD_LGUI, KC_C),MT(MOD_LALT, KC_I),MT(MOD_LSFT, KC_E),MT(MOD_LCTL, KC_A),KC_COMMA,                                       KC_DOT,         MT(MOD_RCTL, KC_H),MT(MOD_RSFT, KC_T),MT(MOD_RALT, KC_S),MT(MOD_RGUI, KC_N),LT(8, KC_V),    
    MT(MOD_LCTL, KC_Z),MT(MOD_LCTL, KC_G),KC_X,           KC_J,           KC_K,           KC_2,                                           KC_4,           KC_R,           KC_M,           KC_F,           MT(MOD_RCTL, KC_P),MT(MOD_RCTL, KC_Q),
    KC_LEFT_SHIFT,  KC_LEFT,        KC_RIGHT,       KC_BSPC,        LT(3, KC_SPACE),KC_LANGUAGE_2,                                  LT(6, KC_LANGUAGE_1),LT(5, KC_SPACE),KC_DELETE,      KC_UP,          KC_DOWN,        KC_RIGHT_SHIFT, 
                                                    LT(6, KC_TAB),  TD(DANCE_2),                                    TD(DANCE_3),    KC_ENTER
  ),
  [2] = LAYOUT_voyager(
