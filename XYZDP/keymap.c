...
#define DUAL_FUNC_19 LT(12, KC_F2)
#define DUAL_FUNC_20 LT(4, KC_W)
#define DUAL_FUNC_21 LT(9, KC_G)
#define DUAL_FUNC_22 LT(11, KC_T)
#define DUAL_FUNC_23 LT(6, KC_F7)
