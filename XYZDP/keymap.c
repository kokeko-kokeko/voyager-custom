...
#define DUAL_FUNC_7 LT(5, KC_F1)
#define DUAL_FUNC_8 LT(15, KC_3)
#define DUAL_FUNC_9 LT(3, KC_F21)
#define DUAL_FUNC_10 LT(15, KC_F23)
#define DUAL_FUNC_11 LT(5, KC_0)
#define DUAL_FUNC_12 LT(12, KC_F22)
#define DUAL_FUNC_13 LT(12, KC_2)
#define DUAL_FUNC_14 LT(9, KC_I)
#define DUAL_FUNC_15 LT(6, KC_R)
#define DUAL_FUNC_16 LT(1, KC_9)
#define DUAL_FUNC_17 LT(5, KC_4)
#define DUAL_FUNC_18 LT(15, KC_F2)
#define DUAL_FUNC_19 LT(3, KC_F16)
#define DUAL_FUNC_20 LT(8, KC_Y)
#define DUAL_FUNC_21 LT(10, KC_F24)
#define DUAL_FUNC_22 LT(14, KC_O)
#define DUAL_FUNC_23 LT(5, KC_1)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    MT(MOD_LCTL, KC_Z),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_RCTL, KC_Q),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
