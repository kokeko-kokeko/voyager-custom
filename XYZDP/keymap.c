...
#define DUAL_FUNC_0 LT(12, KC_P)
#define DUAL_FUNC_1 LT(4, KC_3)
#define DUAL_FUNC_2 LT(15, KC_L)
#define DUAL_FUNC_3 LT(2, KC_F24)
...
#define DUAL_FUNC_9 LT(9, KC_E)
#define DUAL_FUNC_10 LT(9, KC_F12)
#define DUAL_FUNC_11 LT(4, KC_R)
#define DUAL_FUNC_12 LT(2, KC_R)
#define DUAL_FUNC_13 LT(1, KC_C)
#define DUAL_FUNC_14 LT(5, KC_F14)
#define DUAL_FUNC_15 LT(7, KC_F11)
#define DUAL_FUNC_16 LT(12, KC_O)
#define DUAL_FUNC_17 LT(9, KC_H)
#define DUAL_FUNC_18 LT(1, KC_F19)
#define DUAL_FUNC_19 LT(7, KC_W)
#define DUAL_FUNC_20 LT(15, KC_T)
#define DUAL_FUNC_21 LT(6, KC_F19)
#define DUAL_FUNC_22 LT(9, KC_Z)
#define DUAL_FUNC_23 LT(9, KC_3)
...
static bool process_record_rgb_led_int(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case HSV_86_255_101:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[1]);
      }
      return false;
    case HSV_86_255_102:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[2]);
      }
      return false;
    case HSV_86_255_103:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[3]);
      }
      return false;
    case HSV_86_255_104:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[4]);
      }
      return false;
    case HSV_86_255_105:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[5]);
      }
      return false;
    case HSV_86_255_106:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[6]);
      }
      return false;
    case HSV_86_255_107:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[7]);
      }
      return false;
    case HSV_86_255_108:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[8]);
      }
      return false;
    case HSV_86_255_109:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[9]);
      }
      return false;
    case HSV_86_255_110:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[10]);
      }
      return false;
    case HSV_86_255_111:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[11]);
      }
      return false;
    case HSV_86_255_112:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[12]);
      }
      return false;
    case HSV_86_255_113:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[13]);
      }
      return false;
    case HSV_86_255_114:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[14]);
      }
      return false;
    case HSV_86_255_115:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[15]);
      }
      return false;
    case HSV_86_255_116:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[16]);
      }
      return false;
    case HSV_86_255_117:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[17]);
      }
      return false;
    case HSV_86_255_118:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[18]);
      }
      return false;
    case HSV_86_255_119:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[19]);
      }
      return false;
    case HSV_86_255_120:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[20]);
      }
      return false;
    case HSV_86_255_121:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[21]);
      }
      return false;
    case HSV_86_255_122:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[22]);
      }
      return false;
    case HSV_86_255_123:
      if (record->event.pressed) {
        rgblight_set_sat(sat_val_tbl[23]);
      }
      return false;
    ...
    case HSV_86_255_124:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[24]);
      }
      return false;
    case HSV_86_255_125:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[25]);
      }
      return false;
    case HSV_86_255_126:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[26]);
      }
      return false;
    case HSV_86_255_127:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[27]);
      }
      return false;
    case HSV_86_255_128:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[28]);
      }
      return false;
    case HSV_86_255_129:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[29]);
      }
      return false;
    case HSV_86_255_130:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[30]);
      }
      return false;
    case HSV_86_255_131:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[31]);
      }
      return false;
    case HSV_86_255_132:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[32]);
      }
      return false;
    case HSV_86_255_133:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[33]);
      }
      return false;
    case HSV_86_255_134:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[34]);
      }
      return false;
    case HSV_86_255_135:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[35]);
      }
      return false;
    case HSV_86_255_136:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[36]);
      }
      return false;
    case HSV_86_255_137:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[37]);
      }
      return false;
    case HSV_86_255_138:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[38]);
      }
      return false;
    case HSV_86_255_139:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[39]);
      }
      return false;
    case HSV_86_255_140:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[40]);
      }
      return false;
    case HSV_86_255_141:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[41]);
      }
      return false;
    case HSV_86_255_142:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[42]);
      }
      return false;
    case HSV_86_255_143:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[43]);
      }
      return false;
    case HSV_86_255_144:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[44]);
      }
      return false;
    case HSV_86_255_145:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[45]);
      }
      return false;
    case HSV_86_255_146:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[46]);
      }
      return false;
    case HSV_86_255_147:
      if (record->event.pressed) {
        rgblight_set_val(sat_val_tbl[47]);
      }
      return false;
