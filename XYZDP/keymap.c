...
#define DUAL_FUNC_13 LT(11, KC_0)
#define DUAL_FUNC_14 LT(6, KC_W)
#define DUAL_FUNC_15 LT(15, KC_F16)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_A),MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_B),KC_Y,           MT(MOD_LALT | MOD_LSFT, KC_O),MT(MOD_LALT | MOD_LCTL, KC_U),KC_2,                                           KC_3,           MT(MOD_RALT | MOD_RCTL, KC_D),MT(MOD_RALT | MOD_RSFT, KC_N),KC_G,           KC_SLASH,       CW_TOGG,        
  ...
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_QUOTE,                                       KC_2,           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_SLASH,       KC_TRANSPARENT, 
