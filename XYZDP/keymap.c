...
#define DUAL_FUNC_3 LT(11, KC_F19)
#define DUAL_FUNC_4 LT(13, KC_1)
#define DUAL_FUNC_5 LT(1, KC_2)
#define DUAL_FUNC_6 LT(15, KC_4)
#define DUAL_FUNC_7 LT(15, KC_F20)
#define DUAL_FUNC_8 LT(3, KC_F8)
#define DUAL_FUNC_9 LT(2, KC_C)
#define DUAL_FUNC_10 LT(10, KC_F2)
#define DUAL_FUNC_11 LT(14, KC_7)
#define DUAL_FUNC_12 LT(2, KC_F24)
#define DUAL_FUNC_13 LT(2, KC_A)
#define DUAL_FUNC_14 LT(10, KC_F23)
#define DUAL_FUNC_15 LT(1, KC_A)
#define DUAL_FUNC_16 LT(7, KC_F1)
#define DUAL_FUNC_17 LT(4, KC_3)
#define DUAL_FUNC_18 LT(7, KC_H)
#define DUAL_FUNC_19 LT(3, KC_U)
#define DUAL_FUNC_20 LT(9, KC_A)
#define DUAL_FUNC_21 LT(12, KC_0)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN5,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_TURBO,
