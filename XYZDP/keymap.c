...
#define DUAL_FUNC_4 LT(5, KC_D)
#define DUAL_FUNC_5 LT(2, KC_Z)
#define DUAL_FUNC_6 LT(8, KC_F12)
#define DUAL_FUNC_7 LT(9, KC_O)
#define DUAL_FUNC_8 LT(6, KC_F6)
#define DUAL_FUNC_9 LT(9, KC_F6)
#define DUAL_FUNC_10 LT(9, KC_F20)
#define DUAL_FUNC_11 LT(5, KC_U)
...
#define DUAL_FUNC_18 LT(12, KC_F17)
#define DUAL_FUNC_19 LT(15, KC_7)
#define DUAL_FUNC_20 LT(9, KC_F9)
#define DUAL_FUNC_21 LT(4, KC_F24)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    KC_1,           KC_2,           KC_Y,           KC_O,           KC_U,           KC_QUOTE,                                       KC_3,           KC_D,           KC_N,           KC_G,           KC_SLASH,       CW_TOGG,        
