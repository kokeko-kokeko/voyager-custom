...
#define DUAL_FUNC_10 LT(12, KC_F)
#define DUAL_FUNC_11 LT(6, KC_C)
#define DUAL_FUNC_12 LT(9, KC_T)
#define DUAL_FUNC_13 LT(9, KC_F16)
#define DUAL_FUNC_14 LT(10, KC_Z)
#define DUAL_FUNC_15 LT(5, KC_5)
#define DUAL_FUNC_16 LT(11, KC_F18)
#define DUAL_FUNC_17 LT(15, KC_F3)
#define DUAL_FUNC_18 LT(6, KC_5)
#define DUAL_FUNC_19 LT(3, KC_Y)
#define DUAL_FUNC_20 LT(2, KC_F23)
#define DUAL_FUNC_21 LT(10, KC_A)
