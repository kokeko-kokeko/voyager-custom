...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    LGUI(KC_TAB),   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN4,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    MO(9),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(10),         
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN2,                                     KC_MS_BTN1,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RIGHT_CTRL,  
  ...
  [4] = LAYOUT_voyager(
    CW_TOGG,        MT(MOD_LCTL, KC_HOME),MT(MOD_LCTL, KC_END),MT(MOD_RALT, KC_P),MT(MOD_RALT, KC_N),MT(MOD_RSFT | MOD_RCTL, KC_C),                                MT(MOD_RSFT | MOD_RCTL, KC_G),LCTL(KC_V),     KC_UP,          LCTL(KC_C),     KC_APPLICATION, KC_BSPC,        
    MO(9),          MT(MOD_LCTL, KC_PAGE_UP),MT(MOD_LCTL, KC_PGDN),MT(MOD_LALT, KC_C),MT(MOD_LALT, KC_V),MT(MOD_RSFT | MOD_RCTL, KC_D),                                MT(MOD_RSFT | MOD_RCTL, KC_H),KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      MO(10),         
    KC_LEFT_CTRL,   MT(MOD_LALT, KC_Z),MT(MOD_LALT, KC_X),MT(MOD_LALT, KC_P),MT(MOD_LALT, KC_N),MT(MOD_RSFT | MOD_RCTL, KC_E),                                MT(MOD_RSFT | MOD_RCTL, KC_I),MT(MOD_LALT, KC_1),MT(MOD_LALT, KC_2),MT(MOD_LALT, KC_3),MT(MOD_LALT, KC_4),KC_RIGHT_CTRL,  
  ...
  [16] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   MT(MOD_LALT, KC_5),MT(MOD_LALT, KC_6),MT(MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LSFT | MOD_LCTL, KC_M),LGUI(LSFT(KC_V)),                                KC_BSPC,        MT(MOD_LSFT | MOD_LALT, KC_1),MT(MOD_LSFT | MOD_LALT, KC_2),MT(MOD_LSFT | MOD_LALT, KC_3),MT(MOD_LSFT | MOD_LALT, KC_4),KC_RIGHT_CTRL,  
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN6,                                     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN5,                                     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [18] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_MS_BTN8,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_MS_BTN6,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [19] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_CAPS,        KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_F),KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_H),                                KC_NUM,         KC_SCRL,        KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 MT(MOD_LSFT | MOD_LCTL, KC_H),TG(20)
  ),
  [20] = LAYOUT_voyager(
    ...
    MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),                                MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),
    MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),                                MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),MT(MOD_LSFT | MOD_LCTL, KC_C),
                                                    MT(MOD_LSFT | MOD_LCTL, KC_S),MT(MOD_LSFT | MOD_LCTL, KC_D),                                MT(MOD_LSFT | MOD_LCTL, KC_I),KC_TRANSPARENT
  ),
};
