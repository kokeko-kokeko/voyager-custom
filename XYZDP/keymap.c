...
#define DUAL_FUNC_17 LT(12, KC_D)
#define DUAL_FUNC_18 LT(2, KC_I)
#define DUAL_FUNC_19 LT(3, KC_R)
#define DUAL_FUNC_20 LT(8, KC_F22)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_D,           KC_N,           KC_G,           KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, MT(MOD_LGUI, KC_H),KC_TRANSPARENT, MT(MOD_LSFT, KC_A),MT(MOD_LCTL, KC_E),KC_TRANSPARENT,                                 KC_TRANSPARENT, MT(MOD_RCTL, KC_T),MT(MOD_RSFT, KC_R),KC_TRANSPARENT, MT(MOD_RGUI, KC_C),KC_TRANSPARENT, 
    KC_TRANSPARENT, MT(MOD_LCTL, KC_K),MT(MOD_LSFT, KC_J),KC_X,           KC_W,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_M,           KC_L,           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
