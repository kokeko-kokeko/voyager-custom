...
#define DUAL_FUNC_2 LT(5, KC_F19)
#define DUAL_FUNC_3 LT(12, KC_F24)
#define DUAL_FUNC_4 LT(10, KC_K)
#define DUAL_FUNC_5 LT(4, KC_5)
#define DUAL_FUNC_6 LT(9, KC_J)
#define DUAL_FUNC_7 LT(6, KC_F16)
#define DUAL_FUNC_8 LT(6, KC_Y)
#define DUAL_FUNC_9 LT(11, KC_6)
#define DUAL_FUNC_10 LT(6, KC_O)
#define DUAL_FUNC_11 LT(11, KC_C)
#define DUAL_FUNC_12 LT(13, KC_V)
#define DUAL_FUNC_13 LT(5, KC_F16)
#define DUAL_FUNC_14 LT(10, KC_F8)
#define DUAL_FUNC_15 LT(12, KC_O)
#define DUAL_FUNC_16 LT(11, KC_8)
#define DUAL_FUNC_17 LT(13, KC_9)
#define DUAL_FUNC_18 LT(6, KC_F)
#define DUAL_FUNC_19 LT(13, KC_1)
#define DUAL_FUNC_20 LT(4, KC_F4)
#define DUAL_FUNC_21 LT(7, KC_F11)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DRAG_SCROLL,                                    KC_MS_BTN4,     KC_MS_BTN2,     NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_9,  KC_MS_BTN3,                                     KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
