...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   MT(MOD_LALT, KC_Z),MT(MOD_LALT, KC_X),MT(MOD_LALT, KC_P),MT(MOD_LALT, KC_N),MT(MOD_RSFT | MOD_RCTL, KC_E),                                MT(MOD_RSFT | MOD_RCTL, KC_I),MT(MOD_LALT, KC_5),MT(MOD_LALT, KC_6),MT(MOD_LALT, KC_7),MT(MOD_LALT, KC_8),KC_RIGHT_CTRL,  
  ...
  [16] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   MT(MOD_LALT, KC_9),MT(MOD_LALT, KC_0),MT(MOD_LSFT | MOD_LCTL, KC_M),MT(MOD_LSFT | MOD_LCTL, KC_M),LGUI(LSFT(KC_V)),                                KC_BSPC,        MT(MOD_LSFT | MOD_LALT, KC_5),MT(MOD_LSFT | MOD_LALT, KC_6),MT(MOD_LSFT | MOD_LALT, KC_7),MT(MOD_LSFT | MOD_LALT, KC_8),KC_RIGHT_CTRL,  
