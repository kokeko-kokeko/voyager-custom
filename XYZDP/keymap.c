...
#define DUAL_FUNC_3 LT(1, KC_T)
#define DUAL_FUNC_4 LT(9, KC_F22)
#define DUAL_FUNC_5 LT(8, KC_F)
#define DUAL_FUNC_6 LT(3, KC_C)
#define DUAL_FUNC_7 LT(3, KC_Q)
