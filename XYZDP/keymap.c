...
#define DUAL_FUNC_2 LT(14, KC_4)
#define DUAL_FUNC_3 LT(1, KC_F11)
#define DUAL_FUNC_4 LT(9, KC_F8)
#define DUAL_FUNC_5 LT(2, KC_F14)
#define DUAL_FUNC_6 LT(15, KC_Y)
#define DUAL_FUNC_7 LT(13, KC_F6)
#define DUAL_FUNC_8 LT(14, KC_F3)
#define DUAL_FUNC_9 LT(4, KC_E)
#define DUAL_FUNC_10 LT(1, KC_F7)
#define DUAL_FUNC_11 LT(5, KC_T)
#define DUAL_FUNC_12 LT(15, KC_3)
#define DUAL_FUNC_13 LT(2, KC_F6)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    LT(9, KC_B),    MT(MOD_LSFT | MOD_LCTL, KC_H),MT(MOD_LGUI | MOD_LALT, KC_I),MT(MOD_LSFT, KC_A),MT(MOD_LCTL, KC_E),KC_COMMA,                                       KC_DOT,         MT(MOD_RCTL, KC_T),MT(MOD_RSFT, KC_R),MT(MOD_RGUI | MOD_RALT, KC_S),MT(MOD_RSFT | MOD_RCTL, KC_C),LT(10, KC_V),   
    ...
    KC_LEFT_SHIFT,  KC_LEFT,        KC_RIGHT,       KC_BSPC,        LT(4, KC_SPACE),KC_LANGUAGE_2,                                  LT(6, KC_LANGUAGE_1),LT(7, KC_SPACE),KC_DELETE,      KC_UP,          KC_DOWN,        KC_RIGHT_SHIFT, 
                                                    LT(6, KC_TAB),  LT(7, KC_ESCAPE),                                LT(4, KC_BSPC), KC_ENTER
  ),
  [1] = LAYOUT_voyager(
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(4),          KC_TRANSPARENT,                                 KC_TRANSPARENT, MO(7),          KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_RIGHT_SHIFT, 
  ...
  [6] = LAYOUT_voyager(
    ...
    LT(9, KC_F11),  MT(MOD_LSFT | MOD_LCTL, KC_F1),MT(MOD_LGUI | MOD_LALT, KC_F2),MT(MOD_LSFT, KC_F3),MT(MOD_LCTL, KC_F4),KC_F5,                                          KC_F6,          MT(MOD_RCTL, KC_F7),MT(MOD_RSFT, KC_F8),MT(MOD_RGUI | MOD_RALT, KC_F9),MT(MOD_RSFT | MOD_RCTL, KC_F10),LT(10, KC_F12), 
  ...
  [7] = LAYOUT_voyager(
    ...
    MO(9),          LCTL(KC_A),     LCTL(KC_S),     DUAL_FUNC_12,   DUAL_FUNC_13,   KC_SCLN,                                        JP_COLN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      MO(10),         
