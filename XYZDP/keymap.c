...
#define DUAL_FUNC_6 LT(6, KC_A)
#define DUAL_FUNC_7 LT(4, KC_P)
#define DUAL_FUNC_8 LT(14, KC_W)
#define DUAL_FUNC_9 LT(6, KC_I)
#define DUAL_FUNC_10 LT(4, KC_F11)
#define DUAL_FUNC_11 LT(7, KC_5)
#define DUAL_FUNC_12 LT(12, KC_3)
#define DUAL_FUNC_13 LT(1, KC_O)
#define DUAL_FUNC_14 LT(14, KC_F3)
#define DUAL_FUNC_15 LT(13, KC_H)
#define DUAL_FUNC_16 LT(5, KC_F9)
#define DUAL_FUNC_17 LT(13, KC_0)
#define DUAL_FUNC_18 LT(15, KC_Z)
#define DUAL_FUNC_19 LT(4, KC_F)
#define DUAL_FUNC_20 LT(8, KC_P)
#define DUAL_FUNC_21 LT(12, KC_F7)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     DRAG_SCROLL,    KC_MS_BTN1,     KC_MS_BTN3,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN1,                                     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN2,                                     KC_TRANSPARENT, KC_MS_BTN1,     KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,QK_LLCK,        
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [7] = LAYOUT_voyager(
