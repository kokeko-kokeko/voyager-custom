...
#define DUAL_FUNC_0 LT(1, KC_N)
#define DUAL_FUNC_1 LT(7, KC_0)
#define DUAL_FUNC_2 LT(2, KC_2)
#define DUAL_FUNC_3 LT(3, KC_F23)
#define DUAL_FUNC_4 LT(11, KC_F3)
#define DUAL_FUNC_5 LT(1, KC_F24)
#define DUAL_FUNC_6 LT(6, KC_3)
#define DUAL_FUNC_7 LT(2, KC_F7)
#define DUAL_FUNC_8 LT(9, KC_F8)
#define DUAL_FUNC_9 LT(6, KC_L)
#define DUAL_FUNC_10 LT(3, KC_F20)
#define DUAL_FUNC_11 LT(9, KC_M)
#define DUAL_FUNC_12 LT(13, KC_I)
#define DUAL_FUNC_13 LT(7, KC_5)
#define DUAL_FUNC_14 LT(3, KC_F7)
#define DUAL_FUNC_15 LT(7, KC_V)
#define DUAL_FUNC_16 LT(14, KC_H)
#define DUAL_FUNC_17 LT(7, KC_F23)
#define DUAL_FUNC_18 LT(7, KC_F)
#define DUAL_FUNC_19 LT(11, KC_7)
#define DUAL_FUNC_20 LT(8, KC_L)
#define DUAL_FUNC_21 LT(11, KC_H)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN4,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    QK_LLCK,        NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_9,                                  KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
...
layer_state_t layer_state_set_user(layer_state_t state) {
  ...
  state = update_tri_layer_state(state, L_Dummy, L_Set_Speed, L_Set_Sat); 
  ...
  if (is_auto_mouse_active()) {
    if (record->event.pressed == false) {
      switch (keycode) {
        case KC_MS_BTN1:
        case KC_MS_BTN3:
          auto_mouse_context.config.timeout = AUTO_MOUSE_TIME_SHORT;
          break;
        case KC_MS_BTN2:
        case KC_MS_BTN4:
        case KC_MS_BTN5:
          auto_mouse_context.config.timeout = AUTO_MOUSE_TIME;
          break;
      }
    }
  }
