...
layer_state_t layer_state_set_user(layer_state_t state) {
  ...
  switch (layer) {
    ...
    case 2:
    case 3:
      status_led(0b1100, led_pattern_on, 100);
      status_led(0b0011, led_pattern_off, 0);
      break;
    // Num
    case 4:
    case 5:
      status_led(0b0010, led_pattern_on, 100);
    ...
    case 6:
    case 7:
      status_led(0b0001, led_pattern_on, 100);
    ...
    case 8:
    case 9:
      status_led(0b0011, led_pattern_on, 100);
      status_led(0b1100, led_pattern_off, 0);
      break;
    // Lcur
    case 10:
    case 11:
      status_led(0b1000, led_pattern_on, 100);
      status_led(0b0001, led_pattern_blink, 100);
    ...
    case 12:
    case 13:
      status_led(0b0100, led_pattern_on, 100);
      status_led(0b0010, led_pattern_blink, 100);
      status_led(0b1001, led_pattern_off, 0);
      break;
    case 14:
      status_led(0b0100, led_pattern_on, 100);
      status_led(0b0001, led_pattern_on, 350);
      status_led(0b1000, led_pattern_on, 600);
      status_led(0b0010, led_pattern_on, 850);
      break;    
    case 15:
      status_led(0b1111, led_pattern_off, 0);
