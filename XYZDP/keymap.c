...
#define DUAL_FUNC_0 LT(13, KC_1)
#define DUAL_FUNC_1 LT(4, KC_F7)
#define DUAL_FUNC_2 LT(7, KC_B)
#define DUAL_FUNC_3 LT(2, KC_2)
#define DUAL_FUNC_4 LT(10, KC_K)
#define DUAL_FUNC_5 LT(1, KC_I)
#define DUAL_FUNC_6 LT(11, KC_Y)
#define DUAL_FUNC_7 LT(8, KC_Z)
#define DUAL_FUNC_8 LT(11, KC_F10)
#define DUAL_FUNC_9 LT(8, KC_3)
#define DUAL_FUNC_10 LT(1, KC_W)
#define DUAL_FUNC_11 LT(5, KC_F8)
#define DUAL_FUNC_12 LT(7, KC_S)
#define DUAL_FUNC_13 LT(6, KC_Z)
#define DUAL_FUNC_14 LT(3, KC_7)
#define DUAL_FUNC_15 LT(3, KC_6)
#define DUAL_FUNC_16 LT(12, KC_Q)
#define DUAL_FUNC_17 LT(15, KC_K)
#define DUAL_FUNC_18 LT(6, KC_7)
#define DUAL_FUNC_19 LT(5, KC_7)
#define DUAL_FUNC_20 LT(13, KC_B)
#define DUAL_FUNC_21 LT(11, KC_9)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_LEFT,        KC_RIGHT,       KC_BSPC,        LT(4, KC_SPACE),KC_LANGUAGE_2,                                  LT(3, KC_LANGUAGE_1),LT(7, KC_SPACE),KC_DELETE,      KC_UP,          KC_DOWN,        KC_RIGHT_SHIFT, 
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(4),          KC_TRANSPARENT,                                 MO(3),          MO(7),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [6] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 TOGGLE_SCROLL,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN2,                                     DRAG_SCROLL,    KC_MS_BTN1,     KC_MS_BTN3,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN1,                                     KC_TRANSPARENT, KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    QK_LLCK,        NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_TRANSPARENT, KC_MS_BTN1,     KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,QK_LLCK,        
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [7] = LAYOUT_voyager(
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_DYNAMIC_TAPPING_TERM_PRINT,QK_DYNAMIC_TAPPING_TERM_DOWN,QK_DYNAMIC_TAPPING_TERM_UP,KC_NO,          KC_NO,          KC_NO,                                          KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          HSV_215_255_149,
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 MO(18),         KC_NO
  ),
  [18] = LAYOUT_voyager(
...
//
//
// End of GitHub C declaration additional
//
//
// -----------------------------------------------------------------------------
