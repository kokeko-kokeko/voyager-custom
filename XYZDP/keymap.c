...
#define DUAL_FUNC_17 LT(8, KC_O)
#define DUAL_FUNC_18 LT(5, KC_A)
#define DUAL_FUNC_19 LT(2, KC_R)
#define DUAL_FUNC_20 LT(9, KC_5)
#define DUAL_FUNC_21 LT(12, KC_F5)
