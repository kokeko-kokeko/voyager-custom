...
#define DUAL_FUNC_4 LT(6, KC_W)
#define DUAL_FUNC_5 LT(10, KC_Q)
#define DUAL_FUNC_6 LT(11, KC_F18)
#define DUAL_FUNC_7 LT(1, KC_N)
#define DUAL_FUNC_8 LT(14, KC_F8)
#define DUAL_FUNC_9 LT(4, KC_F13)
#define DUAL_FUNC_10 LT(15, KC_F24)
#define DUAL_FUNC_11 LT(11, KC_C)
#define DUAL_FUNC_12 LT(15, KC_9)
#define DUAL_FUNC_13 LT(8, KC_F6)
#define DUAL_FUNC_14 LT(4, KC_F2)
#define DUAL_FUNC_15 LT(5, KC_I)
#define DUAL_FUNC_16 LT(7, KC_F5)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    MT(MOD_LCTL, KC_Z),MT(MOD_LCTL, KC_G),KC_X,           KC_J,           KC_K,           KC_MINUS,                                       KC_4,           KC_R,           KC_M,           KC_F,           MT(MOD_RCTL, KC_P),MT(MOD_RCTL, KC_Q),
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, DUAL_FUNC_8,    DUAL_FUNC_9,    DUAL_FUNC_10,   DUAL_FUNC_11,   KC_SCLN,                                        KC_COLN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      ST_MACRO_0,     
    KC_LEFT_CTRL,   DUAL_FUNC_12,   KC_LABK,        KC_LCBR,        KC_LBRC,        KC_UNDS,                                        KC_EXLM,        KC_RBRC,        KC_RCBR,        KC_RABK,        DUAL_FUNC_13,   KC_RIGHT_CTRL,  
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   DUAL_FUNC_16,   KC_QUES,        ST_MACRO_8,     ST_MACRO_9,     LGUI(LSFT(KC_V)),                                KC_BSPC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RIGHT_CTRL,  KC_RIGHT_CTRL,  
  ...
  [14] = LAYOUT_voyager(
    ...
    QK_DYNAMIC_TAPPING_TERM_PRINT,QK_DYNAMIC_TAPPING_TERM_DOWN,QK_DYNAMIC_TAPPING_TERM_UP,KC_NO,          KC_NO,          KC_NO,                                          KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_NO,          
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 MO(15),         KC_NO
  ),
  [15] = LAYOUT_voyager(
    ...
    HSV_0_255_118,  HSV_0_255_119,  HSV_0_255_120,  HSV_0_255_121,  HSV_0_255_122,  HSV_0_255_123,                                  HSV_0_255_144,  HSV_0_255_145,  HSV_0_255_146,  HSV_0_255_147,  HSV_0_255_148,  HSV_0_255_149,  
                                                    MO(16),         MO(17),                                         KC_TRANSPARENT, HSV_0_255_151
  ),
  [16] = LAYOUT_voyager(
