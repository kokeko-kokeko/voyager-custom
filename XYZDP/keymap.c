...
#define DUAL_FUNC_1 LT(3, KC_S)
#define DUAL_FUNC_2 LT(3, KC_F16)
#define DUAL_FUNC_3 LT(3, KC_F10)
#define DUAL_FUNC_4 LT(11, KC_F15)
#define DUAL_FUNC_5 LT(11, KC_F6)
#define DUAL_FUNC_6 LT(15, KC_V)
#define DUAL_FUNC_7 LT(11, KC_F7)
#define DUAL_FUNC_8 LT(5, KC_F11)
#define DUAL_FUNC_9 LT(1, KC_8)
#define DUAL_FUNC_10 LT(12, KC_O)
#define DUAL_FUNC_11 LT(1, KC_A)
#define DUAL_FUNC_12 LT(5, KC_F20)
#define DUAL_FUNC_13 LT(13, KC_F6)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_LEFT,        KC_RIGHT,       KC_BSPC,        LT(5, KC_SPACE),LT(3, KC_LANGUAGE_2),                                LT(4, KC_LANGUAGE_1),LT(7, KC_SPACE),LT(3, KC_DELETE),KC_UP,          KC_DOWN,        KC_RIGHT_SHIFT, 
