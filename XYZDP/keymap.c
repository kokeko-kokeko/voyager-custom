...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    MO(13),         MO(12),         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     RCTL(KC_MS_BTN1),RSFT(KC_MS_BTN1),RALT(KC_MS_BTN1),RGUI(KC_MS_BTN1),MO(15),         
  ...
  [3] = LAYOUT_voyager(
    ...
    MO(13),         MO(12),         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(14),         MO(15),         
  ...
  [8] = LAYOUT_voyager(
    ...
    MO(13),         MT(MOD_LCTL, KC_PAGE_UP),MT(MOD_LCTL, KC_PGDN),MT(MOD_LALT, KC_C),MT(MOD_LALT, KC_V),MT(MOD_RSFT | MOD_RCTL, KC_D),                                MT(MOD_RSFT | MOD_RCTL, KC_H),KC_LEFT,        KC_DOWN,        KC_RIGHT,       MT(MOD_LCTL, KC_DELETE),MO(15),         
  ...
  [30] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_CAPS,        KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_F),KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_H),                                KC_NUM,         KC_SCRL,        KC_NO,          MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),MT(MOD_LSFT | MOD_LCTL, KC_F),
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 MT(MOD_LSFT | MOD_LCTL, KC_H),MO(31)
  ),
  [31] = LAYOUT_voyager(
