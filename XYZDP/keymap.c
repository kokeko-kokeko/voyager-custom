...
#define DUAL_FUNC_5 LT(13, KC_E)
#define DUAL_FUNC_6 LT(6, KC_N)
#define DUAL_FUNC_7 LT(3, KC_4)
#define DUAL_FUNC_8 LT(13, KC_I)
#define DUAL_FUNC_9 LT(2, KC_C)
#define DUAL_FUNC_10 LT(10, KC_F17)
#define DUAL_FUNC_11 LT(9, KC_F9)
#define DUAL_FUNC_12 LT(4, KC_F17)
#define DUAL_FUNC_13 LT(14, KC_E)
#define DUAL_FUNC_14 LT(4, KC_8)
#define DUAL_FUNC_15 LT(15, KC_F)
#define DUAL_FUNC_16 LT(13, KC_F12)
#define DUAL_FUNC_17 LT(10, KC_7)
#define DUAL_FUNC_18 LT(7, KC_U)
#define DUAL_FUNC_19 LT(3, KC_R)
#define DUAL_FUNC_20 LT(14, KC_F19)
#define DUAL_FUNC_21 LT(13, KC_5)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_LANGUAGE_8,  NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DRAG_SCROLL,                                    KC_MS_BTN4,     KC_MS_BTN2,     KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_7,  KC_MS_BTN3,                                     KC_LANGUAGE_9,  DRAG_SCROLL,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
