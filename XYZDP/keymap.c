...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    MT(MOD_RSFT | MOD_RALT, KC_A),MT(MOD_RSFT | MOD_RALT, KC_A),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     RCTL(KC_MS_BTN1),RSFT(KC_MS_BTN1),RALT(KC_MS_BTN1),RGUI(KC_MS_BTN1),MT(MOD_RSFT | MOD_RALT, KC_A),
