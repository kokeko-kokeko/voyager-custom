...
#define DUAL_FUNC_5 LT(6, KC_T)
#define DUAL_FUNC_6 LT(11, KC_D)
#define DUAL_FUNC_7 LT(14, KC_F)
#define DUAL_FUNC_8 LT(14, KC_F4)
#define DUAL_FUNC_9 LT(12, KC_S)
#define DUAL_FUNC_10 LT(12, KC_F10)
#define DUAL_FUNC_11 LT(8, KC_T)
#define DUAL_FUNC_12 LT(11, KC_F20)
#define DUAL_FUNC_13 LT(7, KC_F15)
#define DUAL_FUNC_14 LT(3, KC_F18)
#define DUAL_FUNC_15 LT(8, KC_Q)
#define DUAL_FUNC_16 LT(11, KC_F9)
#define DUAL_FUNC_17 LT(14, KC_F18)
#define DUAL_FUNC_18 LT(12, KC_F8)
#define DUAL_FUNC_19 LT(8, KC_6)
#define DUAL_FUNC_20 LT(13, KC_F9)
#define DUAL_FUNC_21 LT(8, KC_F17)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN8,     KC_MS_BTN5,                                     KC_TRANSPARENT, KC_MS_BTN4,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_6,  KC_MS_BTN7,     KC_MS_BTN4,                                     KC_MS_BTN1,     KC_MS_BTN2,     KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN6,     DRAG_SCROLL,                                    KC_MS_BTN5,     KC_MS_BTN3,     KC_MS_BTN6,     KC_MS_BTN7,     KC_MS_BTN8,     KC_RIGHT_CTRL,  
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_7,  KC_MS_BTN3,                                     KC_LANGUAGE_8,  KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, 
