...
#define DUAL_FUNC_7 LT(3, KC_F6)
#define DUAL_FUNC_8 LT(1, KC_F17)
#define DUAL_FUNC_9 LT(7, KC_Q)
#define DUAL_FUNC_10 LT(10, KC_U)
#define DUAL_FUNC_11 LT(11, KC_X)
#define DUAL_FUNC_12 LT(5, KC_F3)
#define DUAL_FUNC_13 LT(2, KC_F7)
#define DUAL_FUNC_14 LT(9, KC_6)
#define DUAL_FUNC_15 LT(7, KC_F8)
#define DUAL_FUNC_16 LT(7, KC_V)
#define DUAL_FUNC_17 LT(11, KC_F4)
#define DUAL_FUNC_18 LT(9, KC_0)
#define DUAL_FUNC_19 LT(9, KC_F24)
#define DUAL_FUNC_20 LT(14, KC_F6)
#define DUAL_FUNC_21 LT(10, KC_J)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_8,  KC_MS_BTN3,                                     KC_LANGUAGE_9,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
