...
#define DUAL_FUNC_16 LT(13, KC_7)
#define DUAL_FUNC_17 LT(5, KC_1)
#define DUAL_FUNC_18 LT(1, KC_N)
#define DUAL_FUNC_19 LT(12, KC_F20)
#define DUAL_FUNC_20 LT(2, KC_Q)
