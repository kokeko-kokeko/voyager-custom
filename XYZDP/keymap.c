...
#define DUAL_FUNC_12 LT(8, KC_L)
#define DUAL_FUNC_13 LT(12, KC_D)
#define DUAL_FUNC_14 LT(6, KC_X)
#define DUAL_FUNC_15 LT(3, KC_U)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    JP_AT,          KC_1,           MT(MOD_LALT | MOD_LSFT | MOD_LCTL, KC_Y),MT(MOD_LALT | MOD_LSFT, KC_O),MT(MOD_LALT | MOD_LCTL, KC_U),KC_2,                                           KC_3,           MT(MOD_RALT | MOD_RCTL, KC_D),MT(MOD_RALT | MOD_RSFT, KC_N),MT(MOD_RALT | MOD_RGUI | MOD_RSFT | MOD_RCTL, KC_G),KC_SLASH,       CW_TOGG,        
    LT(10, KC_B),   MT(MOD_LGUI | MOD_LALT, KC_H),MT(MOD_LSFT | MOD_LCTL, KC_I),MT(MOD_LSFT, KC_A),MT(MOD_LCTL, KC_E),KC_COMMA,                                       KC_DOT,         MT(MOD_RCTL, KC_T),MT(MOD_RSFT, KC_R),MT(MOD_RSFT | MOD_RCTL, KC_S),MT(MOD_RGUI | MOD_RALT, KC_C),LT(11, KC_V),   
