...
static const uint16_t * const led_pattern_blink = (uint16_t[]){10, 400, 190, UINT16_MAX, UINT16_MAX, UINT16_MAX};
...
static const uint16_t * const led_pattern_oneshot = (uint16_t[]){10, 100, 50, 100, 50, 100, 50, 100, 50, 100, 50 , 100, 0,UINT16_MAX, UINT16_MAX, UINT16_MAX};
...
layer_state_t layer_state_set_user(layer_state_t state) {
  ...
  switch (layer) {
    ...
    default:
      led_pattern(0b1000, led_pattern_blink, 0);
      led_pattern(0b0100, led_pattern_blink, 100);
      led_pattern(0b0001, led_pattern_blink, 200);
      led_pattern(0b0010, led_pattern_blink, 300);
      break;
  }
  return state;
}
