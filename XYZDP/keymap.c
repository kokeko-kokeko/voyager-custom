...
#define DUAL_FUNC_2 LT(5, KC_U)
#define DUAL_FUNC_3 LT(8, KC_N)
#define DUAL_FUNC_4 LT(1, KC_2)
#define DUAL_FUNC_5 LT(10, KC_C)
#define DUAL_FUNC_6 LT(12, KC_A)
#define DUAL_FUNC_7 LT(5, KC_F)
#define DUAL_FUNC_8 LT(1, KC_F4)
#define DUAL_FUNC_9 LT(9, KC_U)
#define DUAL_FUNC_10 LT(12, KC_L)
#define DUAL_FUNC_11 LT(10, KC_F21)
#define DUAL_FUNC_12 LT(15, KC_F20)
#define DUAL_FUNC_13 LT(1, KC_F2)
#define DUAL_FUNC_14 LT(13, KC_V)
#define DUAL_FUNC_15 LT(7, KC_K)
