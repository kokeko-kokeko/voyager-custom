...
#define DUAL_FUNC_1 LT(4, KC_F18)
#define DUAL_FUNC_2 LT(10, KC_F18)
#define DUAL_FUNC_3 LT(9, KC_S)
#define DUAL_FUNC_4 LT(15, KC_F10)
#define DUAL_FUNC_5 LT(12, KC_F19)
#define DUAL_FUNC_6 LT(11, KC_F14)
#define DUAL_FUNC_7 LT(8, KC_F16)
#define DUAL_FUNC_8 LT(11, KC_F15)
#define DUAL_FUNC_9 LT(14, KC_F19)
#define DUAL_FUNC_10 LT(2, KC_U)
#define DUAL_FUNC_11 LT(7, KC_F6)
#define DUAL_FUNC_12 LT(15, KC_Y)
#define DUAL_FUNC_13 LT(1, KC_F1)
#define DUAL_FUNC_14 LT(15, KC_O)
#define DUAL_FUNC_15 LT(10, KC_W)
#define DUAL_FUNC_16 LT(1, KC_V)
#define DUAL_FUNC_17 LT(4, KC_F2)
#define DUAL_FUNC_18 LT(8, KC_8)
#define DUAL_FUNC_19 LT(11, KC_F22)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    QK_LLCK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_LANGUAGE_6,  KC_MS_BTN7,     KC_MS_BTN4,                                     KC_MS_BTN3,     KC_MS_BTN1,     KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,KC_TRANSPARENT, 
