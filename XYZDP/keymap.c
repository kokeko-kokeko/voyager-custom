...
#define DUAL_FUNC_13 LT(8, KC_F17)
#define DUAL_FUNC_14 LT(10, KC_F10)
#define DUAL_FUNC_15 LT(8, KC_H)
#define DUAL_FUNC_16 LT(5, KC_K)
#define DUAL_FUNC_17 LT(4, KC_F5)
#define DUAL_FUNC_18 LT(6, KC_6)
#define DUAL_FUNC_19 LT(6, KC_M)
#define DUAL_FUNC_20 LT(15, KC_F23)
#define DUAL_FUNC_21 LT(9, KC_X)
#define DUAL_FUNC_22 LT(2, KC_F14)
#define DUAL_FUNC_23 LT(8, KC_F1)
