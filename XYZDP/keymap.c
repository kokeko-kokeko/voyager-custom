...
#define DUAL_FUNC_2 LT(10, KC_A)
#define DUAL_FUNC_3 LT(7, KC_O)
#define DUAL_FUNC_4 LT(6, KC_F14)
#define DUAL_FUNC_5 LT(14, KC_O)
#define DUAL_FUNC_6 LT(14, KC_F19)
#define DUAL_FUNC_7 LT(10, KC_Q)
#define DUAL_FUNC_8 LT(12, KC_O)
#define DUAL_FUNC_9 LT(15, KC_F13)
#define DUAL_FUNC_10 LT(4, KC_L)
#define DUAL_FUNC_11 LT(7, KC_2)
#define DUAL_FUNC_12 LT(11, KC_E)
#define DUAL_FUNC_13 LT(6, KC_G)
#define DUAL_FUNC_14 LT(5, KC_F6)
#define DUAL_FUNC_15 LT(14, KC_N)
#define DUAL_FUNC_16 LT(5, KC_A)
#define DUAL_FUNC_17 LT(12, KC_F16)
#define DUAL_FUNC_18 LT(3, KC_F9)
#define DUAL_FUNC_19 LT(6, KC_F11)
#define DUAL_FUNC_20 LT(10, KC_F3)
#define DUAL_FUNC_21 LT(7, KC_7)
#define DUAL_FUNC_22 LT(4, KC_F16)
#define DUAL_FUNC_23 LT(13, KC_F)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MT(MOD_LCTL, KC_G),KC_TRANSPARENT, KC_TRANSPARENT, KC_K,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_R,           KC_M,           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_voyager(
    ...
    MT(MOD_LCTL, KC_Z),KC_TRANSPARENT, MT(MOD_LSFT, KC_X),KC_J,           KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_RCTL, KC_Q),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
