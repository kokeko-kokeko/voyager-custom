...
#define DUAL_FUNC_6 LT(8, KC_I)
#define DUAL_FUNC_7 LT(2, KC_F18)
...
#define DUAL_FUNC_12 LT(1, KC_F24)
#define DUAL_FUNC_13 LT(11, KC_F23)
#define DUAL_FUNC_14 LT(12, KC_1)
#define DUAL_FUNC_15 LT(8, KC_F10)
#define DUAL_FUNC_16 LT(13, KC_F1)
#define DUAL_FUNC_17 LT(9, KC_F2)
#define DUAL_FUNC_18 LT(11, KC_D)
#define DUAL_FUNC_19 LT(9, KC_F5)
#define DUAL_FUNC_20 LT(11, KC_F5)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,                                          TOGGLE_SCROLL,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DRAG_SCROLL,                                    DRAG_SCROLL,    KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    QK_LLCK,        NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_TRANSPARENT, KC_MS_BTN1,     KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
