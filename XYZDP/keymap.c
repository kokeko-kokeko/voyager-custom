...
#define DUAL_FUNC_0 LT(14, KC_F4)
#define DUAL_FUNC_1 LT(2, KC_6)
#define DUAL_FUNC_2 LT(9, KC_4)
#define DUAL_FUNC_3 LT(12, KC_I)
#define DUAL_FUNC_4 LT(14, KC_F6)
#define DUAL_FUNC_5 LT(11, KC_J)
#define DUAL_FUNC_6 LT(13, KC_8)
#define DUAL_FUNC_7 LT(7, KC_E)
#define DUAL_FUNC_8 LT(4, KC_N)
#define DUAL_FUNC_9 LT(6, KC_1)
#define DUAL_FUNC_10 LT(4, KC_I)
#define DUAL_FUNC_11 LT(7, KC_O)
#define DUAL_FUNC_12 LT(11, KC_1)
#define DUAL_FUNC_13 LT(6, KC_W)
#define DUAL_FUNC_14 LT(8, KC_S)
#define DUAL_FUNC_15 LT(5, KC_D)
#define DUAL_FUNC_16 LT(10, KC_D)
#define DUAL_FUNC_17 LT(7, KC_3)
#define DUAL_FUNC_18 LT(4, KC_E)
#define DUAL_FUNC_19 LT(3, KC_L)
#define DUAL_FUNC_20 LT(2, KC_L)
#define DUAL_FUNC_21 LT(6, KC_F8)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [17] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DRAG_SCROLL,                                    DRAG_SCROLL,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    QK_LLCK,        NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,                                     KC_MS_BTN3,     KC_TRANSPARENT, KC_TRANSPARENT, NAVIGATOR_AIM,  NAVIGATOR_TURBO,QK_LLCK,        
