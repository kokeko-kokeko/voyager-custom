...
(uint8_t[]){255, 251, 247, 243, 239, 235, 231, 227,
...
(uint8_t[]){175, 169, 163, 157, 151, 145, 139, 133,
            127, 121, 116, 112, 110, 108, 106, 104,
            102, 100,  98,  96,  94,  92,  90,  88,
             86,  84,  82,  80,  78,  76,  74,  72,
             70,  68,  66,  64,  62,  59,  55,  49,
...
static void rgblight_load_preset(void) {
  rgblight_sethsv_noeeprom(250, 255, 110);
