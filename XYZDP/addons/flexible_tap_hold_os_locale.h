...
bool process_detected_host_os_flexible_tap_hold_os_locale(os_variant_t detected_os);
bool process_record_flexible_tap_hold_os_locale(uint16_t keycode, keyrecord_t *record);
