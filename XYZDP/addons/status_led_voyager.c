...
// zero start
const uint8_t led_pattern_boot0[] = {0, 3, 15,  31, 125, 125, UINT8_MAX - 1, UINT8_MAX - 1};
const uint8_t led_pattern_boot1[] = {0, 3, 15,  63, 125,  94, UINT8_MAX - 1, UINT8_MAX - 1};
const uint8_t led_pattern_boot2[] = {0, 3, 15,  94, 125,  63, UINT8_MAX - 1, UINT8_MAX - 1}; 
const uint8_t led_pattern_boot3[] = {0, 3, 15, 125, 125,  31, UINT8_MAX - 1, UINT8_MAX - 1};
