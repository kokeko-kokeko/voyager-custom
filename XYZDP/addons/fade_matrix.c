...
static const fast_timer_t fade_matrix_activate_dim_key_add_delay = 3001; // use prime
...
static bool fade_matrix_sync_target = false;
...
static void activate_fade_matrix(void) {
  ...
  fade_matrix_sync_target = fade_matrix_target.enable;
}
...
void housekeeping_task_fade_matrix(void) {
  ...
  if (fade_matrix_sync_target == true) {
    // rgb to enable
    rgb_matrix_enable_noeeprom();
